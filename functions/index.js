!(function (e, a) {
  ...
  (function (e) {
    ...
    function (e, a, n) {
      ...
      function o(e, a) {
        for (
          var n = e.split(/[ ,]+/), t = String(a).toLowerCase(), i = 0;
          i < n.length;
          i++
        ) {
          var o = n[i];
          if (o && ("*" === o || o.toLowerCase() === t)) return !0;
        }
        return !1;
      }
      function r(e) {
      ...
      function s(e, a) {
        var n,
          ...
          i =
            ((n = process),
            (t = "deprecation"),
            ("function" != typeof n.listenerCount
              ? n.listeners(t).length
              : n.listenerCount(t)) > 0);
        if (i || !this._ignored) {
          var o,
            r,
          ...
          for (
            a
              ? ((d = a), ((s = c(h[1])).name = d.name), (b = s[0]))
              : (s = d = c(h[(m = 2)]));
            m < h.length;
            m++
          )
            if ((r = (o = c(h[m]))[0]) === b) v = !0;
            else if (r === this._file) b = this._file;
            else if (v) break;
      ...
      function p(e) {
        ...
        return (
          "Object" === i && (i = void 0),
          "Function" === i && (i = t.name || i),
          i && a.getMethodName() ? i + "." + n : n
        );
      }
      function l(e, a, n) {
        var t =
      ...
      function u(e, a, n) {
        var t = "[36;1m" + this._namespace + "[22;39m [33;1mdeprecated[22;39m [0m" + e + "[39m";
        if (this._traced) {
          for (var i = 0; i < n.length; i++)
            t += "\n    [36mat " + n[i].toString() + "[39m";
          return t;
        }
        return a && (t += " [36m" + d(a) + "[39m"), t;
      }
      function d(e) {
        return t(i, e[0]) + ":" + e[1] + ":" + e[2];
      }
      function f() {
        ...
        var t = a.stack.slice(1);
        return (Error.prepareStackTrace = n), (Error.stackTraceLimit = e), t;
      }
      function m(e, a) {
        return a;
      }
      ...
      function h(e, a, n) {
        ...
        if (!t) throw new TypeError("must call property on owner object");
        if (!t.configurable)
        ...
        "function" == typeof r &&
          (t.get = function () {
            return s.call(i, n, o), r.apply(this, arguments);
          }),
          "function" == typeof p &&
            (t.set = function () {
              return s.call(i, n, o), p.apply(this, arguments);
            }),
          Object.defineProperty(e, a, t);
      }
      function x(e, a, n) {
        ...
        return (
          ...
          Object.defineProperty(i, "stack", {
            ...
            enumerable: !1,
            get: function () {
              return void 0 !== t ? t : (t = r.call(this, n));
            },
            set: function (e) {
              t = e;
            },
    ...
    function (e, a, n) {
      ...
      function f(e) {
        return function (a, n) {
          var i = t.isBuffer(a) ? a : t.from(a, n);
          return p(i, e);
        };
      }
      function m(e) {
      ...
      (a.etag = f({ weak: !1 })),
        ...
        (a.setCharset = function (e, a) {
          if (!e || !a) return e;
          var n = o.parse(e);
          return (n.parameters.charset = a), o.format(n);
        });
    },
    function (e, a) {
    ...
    function (e, a, n) {
      ...
      function l(e, a) {
        ...
        n &&
          n.configurable &&
          ((n.value = a), Object.defineProperty(e, "name", n));
      }
      function u(e) {
        return "Error" !== e.substr(-5) ? e + "Error" : e;
      }
      (e.exports = function e() {
        for (var a, n, t = 500, o = {}, s = 0; s < arguments.length; s++) {
          var c = arguments[s],
            l = typeof c;
          if ("object" === l && c instanceof Error)
            t = (a = c).status || a.statusCode || t;
          else if ("number" === l && 0 === s) t = c;
        ...
        ("number" != typeof t || (!r.message[t] && (t < 400 || t >= 600))) &&
          (t = 500);
        var u = e[t] || e[p(t)];
        a ||
          ((a = u ? new u(n) : new Error(n || r.message[t])),
          Error.captureStackTrace(a, e));
        (u && a instanceof u && a.status === t) ||
          ((a.expose = t < 500), (a.status = a.statusCode = t));
        for (var d in o) "status" !== d && "statusCode" !== d && (a[d] = o[d]);
        return a;
      }),
              ...
              case 400:
                t = (function (e, a, n) {
                  ...
                  return (
                    s(i, e),
                    l(i, t),
                    (i.prototype.status = n),
                    (i.prototype.statusCode = n),
    ...
    function (e, a, n) {
       ...
       */ (e.exports = function (e, a) {
        ...
        if ("number" == typeof e) return s(e, a);
        return null;
      }),
        (e.exports.format = s),
        (e.exports.parse = c);
      ...
      function c(e) {
        ...
        return (
          n
            ? ((a = parseFloat(n[1])), (t = n[4].toLowerCase()))
            : ((a = parseInt(e, 10)), (t = "b")),
          isNaN(a) ? null : Math.floor(o[t] * a)
        );
      }
    },
    function (e, a) {
    ...
    function (e, a, n) {
      ...
      function o(e, a) {
        ...
        if (i && !Array.isArray(i))
          for (i = new Array(arguments.length - 1), n = 0; n < i.length; n++)
            i[n] = arguments[n + 1];
        if (!i || !i.length) return o;
        for (n = 0; n < i.length; n++)
          if (c(s((t = i[n])), o))
            return "+" === t[0] || -1 !== t.indexOf("*") ? o : t;
        return !1;
      }
      function r(e) {
        return (
      ...
      function c(e, a) {
        ...
        return (
          ...
          ("*" === t[0] || t[0] === n[0]) &&
          ("*+" === t[1].substr(0, 2)
            ? t[1].length <= n[1].length + 1 &&
              t[1].substr(1) === n[1].substr(1 - t[1].length)
            : "*" === t[1] || t[1] === n[1])
        );
      }
      function p(e) {
        ...
        try {
          return (function (e) {
            var a = t.parse(e);
            return (a.parameters = void 0), t.format(a);
          })(e);
        } catch (e) {
          return null;
        }
      ...
      (e.exports = function (e, a) {
        ...
        if (arguments.length > 2) {
          ...
          for (var t = 0; t < n.length; t++) n[t] = arguments[t + 1];
        }
    ...
    function (e, a, n) {
      ...
      function r(e) {
        ...
        if (void 0 !== a) {
          var n = e._parsedUrl;
          return c(a, n) ? n : (((n = s(a))._raw = a), (e._parsedUrl = n));
        }
      }
      function s(e) {
        if ("string" != typeof e || 47 !== e.charCodeAt(0)) return i(e);
        for (var a = e, n = null, t = null, r = 1; r < e.length; r++)
      ...
      (e.exports = r),
        (e.exports.original = function (e) {
          ...
          if (c(a, n)) return n;
          return ((n = s(a))._raw = a), (e._parsedOriginalUrl = n);
        });
    },
    function (e, a, n) {
    ...
    function (e, a, n) {
      ...
      (a.format = function (e) {
        ...
        if (a && "object" == typeof a)
          for (var i, r = Object.keys(a).sort(), s = 0; s < r.length; s++) {
            if (((i = r[s]), !o.test(i)))
        ...
        (a.parse = function (e) {
          ...
          var n = a.indexOf(";"),
            i = -1 !== n ? a.substr(0, n).trim() : a.trim();
          if (!c.test(i)) throw new TypeError("invalid media type");
          var o = new l(i.toLowerCase());
          if (-1 !== n) {
            var s, p, u;
            for (t.lastIndex = n; (p = t.exec(a)); ) {
              if (p.index !== n)
            ...
            if (n !== a.length) throw new TypeError("invalid parameter format");
          }
          return o;
        });
    },
    function (e, a, n) {
      ...
      e.exports =
        ...
        ({ __proto__: [] } instanceof Array
          ...
          : function (e, a) {
              for (var n in a)
                Object.prototype.hasOwnProperty.call(e, n) || (e[n] = a[n]);
              return e;
            });
    },
    function (e, a, n) {
    ...
    function (e, a, n) {
       ...
       */ var t = n(9),
        ...
        c = n(30),
        p = n(28);
      e.exports = function (e, a, n, l, u, d) {
        var f,
          m,
          v = d;
        e._body = !0;
        ...
        try {
          (m = (function (e, a, n) {
            ...
            if ((a('content-encoding "%s"', o), !1 === n && "identity" !== o))
            ...
            switch (o) {
              case "deflate":
                (i = p.createInflate()), a("inflate body"), e.pipe(i);
                break;
              case "gzip":
                (i = p.createGunzip()), a("gunzip body"), e.pipe(i);
                break;
              case "identity":
                (i = e).length = r;
                break;
              default:
                throw t(415, 'unsupported content encoding "' + o + '"', {
                  encoding: o,
                  type: "encoding.unsupported",
                });
            }
        ...
        if (
          ((v.length = f),
          (v.encoding = x ? null : h),
          null === v.encoding && null !== h && !r.encodingExists(h))
        )
          return n(
            t(415, 'unsupported charset "' + h.toUpperCase() + '"', {
              charset: h.toLowerCase(),
        ...
        u("read body"),
          o(m, v, function (o, p) {
            ...
            if (x)
              try {
                u("verify body"), x(e, a, p, h);
              } catch (e) {
                return void n(
                  t(403, e, { body: p, type: e.type || "entity.verify.failed" })
                );
              }
            var f = p;
            try {
              u("parse body"),
                (f = "string" != typeof p && null !== h ? r.decode(p, h) : p),
                (e.body = l(f));
            } catch (e) {
              return void n(
                t(400, e, { body: f, type: e.type || "entity.parse.failed" })
              );
            }
            n();
          });
        ...
        return (
          (function (e, a) {
            ...
            (n && n.queue) ||
              ...
              (function (e, a) {
                var n,
                  ...
                  o = !1;
                function r(e) {
                  n.cancel(), t.cancel(), (o = !0), a(e);
                }
                function s(a) {
                  e.removeListener("socket", s),
                    o || (n === t && (t = i([[a, "error", "close"]], r)));
                }
                if (((n = t = i([[e, "end", "finish"]], r)), e.socket))
            ...
            (function (e) {
              var a;
              t.AsyncResource &&
                (a = new t.AsyncResource(e.name || "bound-anonymous-fn"));
              if (!a || !a.runInAsyncScope) return e;
    ...
    function (e, a, n) {
      ...
      e.exports = function (e) {
        ...
        for (r = i.index; r < n.length; r++) {
          ...
          s !== r && (o += n.substring(s, r)), (s = r + 1), (o += a);
        }
        return s !== r ? o + n.substring(s, r) : o;
      };
    },
    function (e, a, n) {
      "use strict";
      e.exports = function (e, a) {
        ...
        return (function e(a, n, t) {
          for (var i = 0; i < a.length; i++) {
            var o = a[i];
            t > 0 && Array.isArray(o) ? e(o, n, t - 1) : n.push(o);
          }
          return n;
        })(e, [], a);
      };
    ...
    function (e, a, n) {
       ...
       */ e.exports = function (e) {
        ...
        if (
          !(function (e) {
            for (var a = e.listeners("data"), n = 0; n < a.length; n++)
              if ("ondata" === a[n].name) return !0;
            return !1;
          })(e)
        )
          return;
        for (var a, n = e.listeners("close"), t = 0; t < n.length; t++)
          ("cleanup" !== (a = n[t]).name && "onclose" !== a.name) || a.call(e);
      };
    },
    function (e, a, n) {
      "use strict";
      var t = n(105),
        i = n(115),
        o = n(34);
      e.exports = { formats: o, parse: i, stringify: t };
    },
    function (e, a, n) {
      "use strict";
      var t = SyntaxError,
      ...
      var c = function () {
        ...
        h = n(33),
        x = n(110),
        b = h.call(Function.call, Array.prototype.concat),
        g = h.call(Function.apply, Array.prototype.splice),
        y = h.call(Function.call, String.prototype.replace),
        w = h.call(Function.call, String.prototype.slice),
        k =
          /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
        E = /\\(\\)?/g,
        O = function (e) {
          ...
          var i = [];
          return (
            y(e, k, function (e, a, n, t) {
              i[i.length] = n ? y(t, E, "$1") : a || e;
            }),
            i
          );
        },
        S = function (e, a) {
          var n,
            i = e;
          if ((x(v, i) && (i = "%" + (n = v[i])[0] + "%"), x(m, i))) {
            var s = m[i];
            if (
              (s === d &&
                (s = (function e(a) {
                  var n;
                  if ("%AsyncFunction%" === a) n = r("async function () {}");
                  else if ("%GeneratorFunction%" === a)
                    n = r("function* () {}");
        ...
        for (var d = 1, f = !0; d < n.length; d += 1) {
          ...
          if (
            ...
            if (s && d + 1 >= n.length) {
              var k = s(p, v);
              p =
                (f = !!k) && "get" in k && !("originalValue" in k.get)
                  ? k.get
                  : p[v];
            } else (f = x(p, v)), (p = p[v]);
            f && !l && (m[c] = p);
    ...
    function (e, a, n) {
      ...
      i.from && i.alloc && i.allocUnsafe && i.allocUnsafeSlow
        ...
        o(i, r),
        (r.from = function (e, a, n) {
          if ("number" == typeof e)
            throw new TypeError("Argument must not be a number");
          return i(e, a, n);
        }),
        (r.alloc = function (e, a, n) {
          if ("number" != typeof e)
    ...
    function (e, a, n) {
      ...
      function C(e, a, n) {
        ...
        if (
          ...
          (this.req = e),
          (this._acceptRanges =
            void 0 === t.acceptRanges || Boolean(t.acceptRanges)),
          (this._cacheControl =
            void 0 === t.cacheControl || Boolean(t.cacheControl)),
          (this._etag = void 0 === t.etag || Boolean(t.etag)),
          (this._dotfiles = void 0 !== t.dotfiles ? t.dotfiles : "ignore"),
        ...
        (this._hidden = Boolean(t.hidden)),
          ...
          void 0 === t.dotfiles && (this._dotfiles = void 0),
          (this._extensions =
            void 0 !== t.extensions
              ? A(t.extensions, "extensions option")
              : []),
          (this._immutable = void 0 !== t.immutable && Boolean(t.immutable)),
          (this._index =
            void 0 !== t.index ? A(t.index, "index option") : ["index.html"]),
          (this._lastModified =
            void 0 === t.lastModified || Boolean(t.lastModified)),
          (this._maxage = t.maxAge || t.maxage),
          (this._maxage =
          ...
          (this._root = t.root ? E(t.root) : null),
          !this._root && t.from && this.from(t.from);
      }
      function T(e, a, n) {
        return e + " " + (n ? n.start + "-" + n.end : "*") + "/" + a;
      }
      function I(e, a) {
        return (
          '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="utf-8">\n<title>' +
      ...
      function A(e, a) {
        for (var n = [].concat(e || []), t = 0; t < n.length; t++)
      ...
      (e.exports = function (e, a, n) {
        ...
        (C.prototype.index = o.function(function (e) {
          ...
          return i("index %o", e), (this._index = a), this;
        }, "send.index: pass index as option")),
        (C.prototype.root = function (e) {
          return (this._root = E(String(e))), i("root %s", this._root), this;
        }),
        ...
        (C.prototype.error = function (e, a) {
          if (_(this, "error"))
            return this.emit(
              ...
              (function (e, a) {
                if (!a) return t(e);
                return a instanceof Error ? t(e, a, { expose: !1 }) : t(e, a);
              })(e, a)
            );
          var n = this.res,
          ...
          !(function (e) {
            ...
            a &&
              a.headers &&
              (function (e, a) {
                for (var n = Object.keys(a), t = 0; t < n.length; t++) {
                  var i = n[t];
                  e.setHeader(i, a[i]);
                }
              })(n, a.headers),
        ...
        (C.prototype.isPreconditionFailure = function () {
          ...
          if (n) {
            var t = a.getHeader("ETag");
            return (
              !t ||
              ("*" !== n &&
                (function (e) {
                  for (
                    var a = 0, n = [], t = 0, i = 0, o = e.length;
                    i < o;
                    i++
                  )
                    switch (e.charCodeAt(i)) {
                      case 32:
                        ...
                        break;
                      case 44:
                        t !== a && n.push(e.substring(t, a)), (t = a = i + 1);
                        break;
                      default:
                        a = i + 1;
                    }
                  t !== a && n.push(e.substring(t, a));
                  return n;
                })(n).every(function (e) {
                  return e !== t && e !== "W/" + t && "W/" + e !== t;
                }))
            );
          }
          var i = q(e.headers["if-unmodified-since"]);
          if (!isNaN(i)) {
            var o = q(a.getHeader("Last-Modified"));
            return isNaN(o) || o > i;
          }
          return !1;
        }),
        ...
        (C.prototype.redirect = function (e) {
          var a = this.res;
          if (_(this, "directory")) this.emit("directory", a, e);
        ...
        (C.prototype.pipe = function (e) {
          ...
          if (-1 === t) return this.error(400), e;
          if (~t.indexOf("\0")) return this.error(400), e;
          if (null !== a) {
            if ((t && (t = k("." + O + t)), j.test(t)))
              return i('malicious path "%s"', t), this.error(403), e;
            (n = t.split(O)), (t = k(w(a, t)));
          } else {
            if (j.test(t))
              return i('malicious path "%s"', t), this.error(403), e;
            (n = k(t).split(O)), (t = E(t));
        ...
        (C.prototype.send = function (e, a) {
          ...
          if (
            ...
            if (((n = Math.max(0, n - p)), void 0 !== t.end)) {
              var l = t.end - p + 1;
              n > l && (n = l);
            }
            if (this._acceptRanges && S.test(c)) {
              if (
                ...
                return (
                  ...
                  r.setHeader("Content-Range", T("bytes", n)),
                  this.error(416, {
              ...
              -2 !== c &&
                ...
                (i("range %j", c),
                (r.statusCode = 206),
                r.setHeader("Content-Range", T("bytes", n, c[0])),
                (p += c[0].start),
        ...
        (C.prototype.sendFile = function (e) {
          var a = 0,
            n = this;
          i('stat "%s"', e),
            u.stat(e, function (t, o) {
              return t && "ENOENT" === t.code && !y(e) && e[e.length - 1] !== O
                ? (function t(o) {
                    if (n._extensions.length <= a)
                      return o ? n.onStatError(o) : n.error(404);
                    var r = e + "." + n._extensions[a++];
                    i('stat "%s"', r),
                      u.stat(r, function (e, a) {
                        return e
                          ? t(e)
                          : a.isDirectory()
                          ? t()
                          : (n.emit("file", r, a), void n.send(r, a));
                      });
                  })(t)
                : t
                ? n.onStatError(t)
                : o.isDirectory()
                ? n.redirect(e)
                : (n.emit("file", e, o), void n.send(e, o));
            });
        }),
        ...
        (C.prototype.type = function (e) {
          ...
          if (!a.getHeader("Content-Type")) {
            var n = d.lookup(e);
            if (n) {
              var t = d.charsets.lookup(n);
              i("content-type %s", n),
                a.setHeader("Content-Type", n + (t ? "; charset=" + t : ""));
        ...
        (C.prototype.setHeader = function (e, a) {
          ...
          if (
            ...
            this._immutable && (t += ", immutable"),
              i("cache-control %s", t),
              n.setHeader("Cache-Control", t);
          }
          if (this._lastModified && !n.getHeader("Last-Modified")) {
            var o = a.mtime.toUTCString();
            i("modified %s", o), n.setHeader("Last-Modified", o);
          }
          if (this._etag && !n.getHeader("ETag")) {
            var r = p(a);
            i("etag %s", r), n.setHeader("ETag", r);
          }
        });
    },
    ,
    function (e, a, n) {
      ...
      (a.charset = l),
        ...
        (a.extension = function (e) {
          if (!e || "string" != typeof e) return !1;
          var n = c.exec(e),
            t = n && a.extensions[n[1].toLowerCase()];
    ...
    function (e, a, n) {
        ...
        function n() {
          if (n.enabled) {
            ...
            for (var r = new Array(arguments.length), s = 0; s < r.length; s++)
              r[s] = arguments[s];
            (r[0] = a.coerce(r[0])), "string" != typeof r[0] && r.unshift("%O");
            var c = 0;
            (r[0] = r[0].replace(/%([a-zA-Z%])/g, function (n, t) {
              if ("%%" === n) return n;
              c++;
              var i = a.formatters[t];
              if ("function" == typeof i) {
                var o = r[c];
                (n = i.call(e, o)), r.splice(c, 1), c--;
              }
              return n;
            })),
              a.formatArgs.call(e, r);
            var p = n.log || a.log || console.log.bind(console);
            p.apply(e, r);
          }
        }
        return (
          ...
          (n.color = (function (e) {
            var n,
              t = 0;
            for (n in e) (t = (t << 5) - t + e.charCodeAt(n)), (t |= 0);
      ...
      ((a = e.exports = i.debug = i.default = i).coerce = function (e) {
        ...
        (a.enabled = function (e) {
          var n, t;
          for (n = 0, t = a.skips.length; n < t; n++)
            if (a.skips[n].test(e)) return !1;
          for (n = 0, t = a.names.length; n < t; n++)
            if (a.names[n].test(e)) return !0;
          return !1;
        }),
        (a.humanize = n(78)),
        (a.names = []),
            ...
            ? (function (e) {
                "function" == typeof e.destroy
                  ...
                  : "function" == typeof e.close &&
                    (function (e) {
                      if (!0 === e._hadError) {
                        var a = null === e._binding ? "_binding" : "_handle";
                        e[a] = {
                          close: function () {
                            this[a] = null;
                          },
    ...
    function (e, a, n) {
      ...
      (o.encodings = null),
        ...
        (o.encode = function (e, a, n) {
          e = "" + (e || "");
          var i = o.getEncoder(a, n),
            r = i.write(e),
            s = i.end();
          return s && s.length > 0 ? t.concat([r, s]) : r;
        }),
        ...
        (o.getCodec = function (e) {
          o.encodings || (o.encodings = n(82));
          for (var a = o._canonicalizeEncoding(e), t = {}; ; ) {
            var i = o._codecDataCache[a];
            if (i) return i;
            var r = o.encodings[a];
            switch (typeof r) {
              case "string":
              ...
              case "object":
                ...
                t.encodingName || (t.encodingName = a), (a = r.type);
                break;
              case "function":
                return (
                  t.encodingName || (t.encodingName = a),
                  (i = new r(t, o)),
                  (o._codecDataCache[t.encodingName] = i),
                  i
                );
              default:
                throw new Error(
        ...
        (o.getEncoder = function (e, a) {
          var n = o.getCodec(e),
            t = new n.encoder(a, n);
          return n.bomAware && a && a.addBOM && (t = new i.PrependBOM(t, a)), t;
        }),
    ...
    function (e, a, n) {
      ...
      var t = n(34),
        ...
        s = function (e, a) {
          for (
            var n = a && a.plainObjects ? Object.create(null) : {}, t = 0;
            t < e.length;
            ++t
          )
            void 0 !== e[t] && (n[t] = e[t]);
      ...
      e.exports = {
        ...
        compact: function (e) {
          for (
            var a = [{ obj: { o: e }, prop: "o" }], n = [], t = 0;
            t < a.length;
            ++t
          )
            for (
              var i = a[t], r = i.obj[i.prop], s = Object.keys(r), c = 0;
              c < s.length;
              ++c
            ) {
              var p = s[c],
        ...
        maybeMap: function (e, a) {
          if (o(e)) {
            for (var n = [], t = 0; t < e.length; t += 1) n.push(a(e[t]));
            return n;
          }
          return a(e);
        },
        merge: function e(a, n, t) {
          if (!n) return a;
          if ("object" != typeof n) {
            if (o(a)) a.push(n);
            else {
              if (!a || "object" != typeof a) return [a, n];
          ...
          if (!a || "object" != typeof a) return [a].concat(n);
          var r = a;
          return (
            o(a) && !o(n) && (r = s(a, t)),
            o(a) && o(n)
              ? (n.forEach(function (n, o) {
                ...
                a)
              : Object.keys(n).reduce(function (a, o) {
                  var r = n[o];
                  return i.call(a, o) ? (a[o] = e(a[o], r, t)) : (a[o] = r), a;
                }, r)
          );
        },
      };
    ...
    function (e, a, n) {
      ...
      function x(e) {
        var a = typeof e;
        return "object" !== a ? a : m.call(e).replace(d, "$1");
      }
      function b(e, a) {
        try {
          return e.match(a);
      ...
      (v.param = function (e, a) {
          ...
          var i = 0,
            o =
              (function (e) {
                ...
                var a = e.indexOf("?"),
                  n = -1 !== a ? a : e.length,
                  t = e.slice(0, n).indexOf("://");
                return -1 !== t
                  ? e.substring(0, e.indexOf("/", 3 + t))
                  : void 0;
              })(e.url) || "",
            c = "",
            p = !1,
            ...
            g = (function (e, a) {
              for (
                ...
                (n[i] = arguments[i + 2]), (t[i] = a[n[i]]);
              return function () {
                for (var i = 0; i < n.length; i++) a[n[i]] = t[i];
                return e.apply(this, arguments);
              };
            })(n, e, "baseUrl", "next", "params");
          function y(n) {
            var w = "route" === n ? null : n;
            if (
              ...
              if (i >= m.length) setImmediate(g, w);
              else {
                if (++u > 100) return setImmediate(y, n);
                var k,
                  E,
                  O,
                  S = (function (e) {
                ...
                if (null == S) return g(w);
                for (; !0 !== E && i < m.length; )
                  if (
                    ((E = b((k = m[i++]), S)),
                    (O = k.route),
                    "boolean" != typeof E && (w = w || E),
                    !0 === E && O)
                  )
                    if (w) E = !1;
                    else {
                      var j = e.method,
                        C = O._handles_method(j);
                      C || "OPTIONS" !== j || h(f, O._options()),
                        C || "HEAD" === j || (E = !1);
                    }
                if (!0 !== E) return g(w);
                O && (e.route = O),
                  (e.params = t.mergeParams
                    ? (function (e, a) {
                        if ("object" != typeof a || !a) return e;
                        var n = r({}, a);
                        if (!(0 in e) || !(0 in a)) return r(n, e);
                        var t = 0,
                          i = 0;
                        for (; t in e; ) t++;
                        for (; i in a; ) i++;
                        for (t--; t >= 0; t--)
                          (e[t + i] = e[t]), t < i && delete e[t];
                        return r(n, e);
                      })(k.params, v)
                    : k.params);
                var T = k.path;
                t.process_params(k, d, e, a, function (n) {
                  n
                    ? y(w || n)
                    : O
                    ...
                    : (function (n, t, i, r) {
                        if (0 !== i.length) {
                          if (i !== r.slice(0, i.length)) return void y(t);
                          var l = r[i.length];
                          if (l && "/" !== l && "." !== l) return y(t);
                        ...
                        s("%s %s : %s", n.name, i, e.originalUrl),
                          t
                            ? n.handle_error(t, e, a, y)
                            : n.handle_request(e, a, y);
                      })(k, w, T, S),
                    (u = 0);
                });
              }
            else setImmediate(g, null);
          }
          (e.next = y),
            "OPTIONS" === e.method &&
              (g = (function (e, a) {
                ...
                if (n || 0 === f.length) return e(n);
                !(function (e, a, n) {
                  try {
                    var t = a.join(",");
                    e.set("Allow", t), e.send(t);
                  } catch (e) {
                    n(e);
                  }
                })(a, f, e);
        ...
        (v.process_params = function (e, a, n, t, i) {
          var o = this.params,
            r = e.keys;
        ...
        (v.use = function (e) {
          var a = 0,
            n = "/";
          if ("function" != typeof e) {
            for (var t = e; Array.isArray(t) && 0 !== t.length; ) t = t[0];
            "function" != typeof t && ((a = 1), (n = e));
          }
          var o = p(f.call(arguments, a));
          if (0 === o.length)
            throw new TypeError("Router.use() requires a middleware function");
          for (var r = 0; r < o.length; r++) {
            if ("function" != typeof (e = o[r]))
              throw new TypeError(
                "Router.use() requires a middleware function but got a " + x(e)
              );
    ...
    function (e, a, n) {
       ...
       * Copyright(c) 2014-2015 Douglas Christopher Wilson
       * MIT Licensed
       */ var t = n(16)("express:router:route"),
        i = n(26),
        o = n(53),
        r = n(35),
      ...
      function p(e) {
        (this.path = e), (this.stack = []), t("new %o", e), (this.methods = {});
      }
      (e.exports = p),
        ...
        (p.prototype.dispatch = function (e, a, n) {
          var t = 0,
            i = this.stack,
            o = 0;
          ...
          "head" !== r || this.methods.head || (r = "get"),
            ...
            (function s(c) {
              ...
              if (p.method && p.method !== r) return s(c);
              c ? p.handle_error(c, e, a, s) : p.handle_request(e, a, s);
              o = 0;
            })();
        }),
        (p.prototype.all = function () {
          for (var e = i(s.call(arguments)), a = 0; a < e.length; a++) {
            var n = e[a];
            if ("function" != typeof n) {
              var t = c.call(n),
                r = "Route.all() requires a callback function but got a " + t;
        ...
        r.forEach(function (e) {
          p.prototype[e] = function () {
            for (var a = i(s.call(arguments)), n = 0; n < a.length; n++) {
              var r = a[n];
    ...
    function (e, a, n) {
       ...
       * MIT Licensed
       */ var t = n(126),
        i = n(16)("express:router:layer"),
        o = Object.prototype.hasOwnProperty;
      function r(e, a, n) {
        if (!(this instanceof r)) return new r(e, a, n);
        i("new %o", e);
        var o = a || {};
        (this.handle = n),
      ...
      (e.exports = r),
        (r.prototype.handle_error = function (e, a, n, t) {
          var i = this.handle;
          if (4 !== i.length) return t(e);
          try {
            i(e, a, n, t);
          } catch (e) {
            t(e);
        ...
        (r.prototype.handle_request = function (e, a, n) {
          var t = this.handle;
        ...
        (r.prototype.match = function (e) {
          ...
          for (var n = this.keys, t = this.params, i = 1; i < a.length; i++) {
            var r = n[i - 1].name,
              c = s(a[i]);
            (void 0 === c && o.call(t, r)) || (t[r] = c);
          }
          return !0;
        });
    },
    function (e, a, n) {
      ...
      e.exports = function (e) {
        var a = t({}, e),
          n = o.parse;
        return (
          "function" == typeof e && ((n = e), (a = void 0)),
          void 0 !== a &&
       ...
       */ (e.exports = function (e, a) {
        var n = a || {},
          ...
          o = (function (e, a) {
            ...
            var i = t(e),
              o = d.test(i),
              s = "string" != typeof a ? a && x(i) : t(a),
              p = "string" == typeof s && s !== i;
            (p || !o || r.test(i)) && (n["filename*"] = i);
            (o || p) && (n.filename = p ? s : i);
            return n;
          })(e, n.fallback);
        return (function (e) {
          var a = e.parameters,
          ...
          if (a && "object" == typeof a)
            for (var i, o = Object.keys(a).sort(), r = 0; r < o.length; r++) {
              var s = "*" === (i = o[r]).substr(-1) ? w(a[i]) : y(a[i]);
              t += "; " + i + "=" + s;
            }
          return t;
        })(new k(i, o));
        ...
        (e.exports.parse = function (e) {
          ...
          var n,
            ...
            r = [],
            s = {};
          i = u.lastIndex = ";" === a[0].substr(-1) ? i - 1 : i;
          for (; (a = u.exec(e)); ) {
            if (a.index !== i) throw new TypeError("invalid parameter format");
            if (
              ((i += a[0].length),
              (n = a[1].toLowerCase()),
              (t = a[2]),
            ...
            r.push(n),
              n.indexOf("*") + 1 !== n.length
                ? "string" != typeof s[n] &&
                  ('"' === t[0] &&
                    (t = t.substr(1, t.length - 2).replace(p, "$1")),
                  (s[n] = t))
                : ((n = n.slice(0, -1)), (t = h(t)), (s[n] = t));
          }
          if (-1 !== i && i !== e.length)
            throw new TypeError("invalid parameter format");
          return new k(o, s);
      ...
      function h(e) {
        ...
        switch (t) {
          case "iso-8859-1":
            ...
            break;
          case "utf-8":
            n = i.from(o, "binary").toString("utf8");
            break;
          default:
    ...
    function (e, a, n) {
       ...
       */ e.exports = function (e, a) {
        ...
        var n = (function (e) {
          ...
          r = a && "boolean" == typeof a.weak ? a.weak : n;
      ...
      e.exports = function (e, a) {
        ...
        if (o && "*" !== o) {
          ...
          for (
            var c = !0,
              p = (function (e) {
                for (var a = 0, n = [], t = 0, i = 0, o = e.length; i < o; i++)
                  switch (e.charCodeAt(i)) {
                    case 32:
                      t === a && (t = a = i + 1);
                      break;
                    case 44:
                      n.push(e.substring(t, a)), (t = a = i + 1);
                      break;
                    default:
                      a = i + 1;
                  }
                return n.push(e.substring(t, a)), n;
              })(o),
              l = 0;
            l < p.length;
            l++
    ...
    function (e, a, n) {
      ...
      e.exports = function (e, a, n) {
        ...
        return n && n.combine
          ? (function (e) {
              for (var a = e.map(t).sort(r), n = 0, s = 1; s < a.length; s++) {
                var c = a[s],
                  p = a[n];
                c.start > p.end + 1
                  ? (a[++n] = c)
    ...
    function (e, a, n) {
      ...
      function p(e, a) {
        ...
        for (var i = 0; i < n.length - 1; i++) a(n[i], i) || (n.length = i + 1);
        return n;
      }
      function l(e) {
        ...
        return (function (e) {
          ...
          return 0 === a
            ...
            : ((n = e),
              function (e) {
                if (!r(e)) return !1;
                for (var a, t = s(e), i = t.kind(), o = 0; o < n.length; o++) {
                  var c = n[o],
                    p = c[0],
                    l = p.kind(),
                    u = c[1],
                    d = t;
                  if (i !== l) {
                    if ("ipv4" === l && !t.isIPv4MappedAddress()) continue;
                    a ||
                      (a =
                        "ipv4" === l
                          ? t.toIPv4Address()
                          : t.toIPv4MappedAddress()),
                      (d = a);
                  }
          ...
          (function (e) {
            for (var a = new Array(e.length), n = 0; n < e.length; n++)
              a[n] = u(e[n]);
            return a;
          })(a)
        );
      ...
      e.exports = function (e, a) {
        ...
        if ("number" === s && isFinite(e))
          return a.long
            ? (function (e) {
                var a = Math.abs(e);
                if (a >= o) return r(e, a, o, "day");
                if (a >= i) return r(e, a, i, "hour");
                if (a >= t) return r(e, a, t, "minute");
                if (a >= n) return r(e, a, n, "second");
                return e + " ms";
              })(e)
            : (function (e) {
                var a = Math.abs(e);
                if (a >= o) return Math.round(e / o) + "d";
                if (a >= i) return Math.round(e / i) + "h";
                if (a >= t) return Math.round(e / t) + "m";
                if (a >= n) return Math.round(e / n) + "s";
                return e + "ms";
              })(e);
        throw new Error(
    ...
    function (e, a, n) {
      ...
      function o(e) {
        ...
        (this.headers = e.headers), (this.negotiator = new t(e));
      }
      function r(e) {
        ...
        (o.prototype.type = o.prototype.types =
          function (e) {
            ...
            if (a && !Array.isArray(a)) {
              ...
              for (var n = 0; n < a.length; n++) a[n] = arguments[n];
            }
            if (!a || 0 === a.length) return this.negotiator.mediaTypes();
            if (!this.headers.accept) return a[0];
            var t = a.map(r),
              i = this.negotiator.mediaTypes(t.filter(s)),
              o = i[0];
            return !!o && a[t.indexOf(o)];
          }),
    ...
    function (e, a, n) {
       ...
       */ (e.exports = function (e, a) {
        ...
        var n = e.getHeader("Vary") || "",
          t = Array.isArray(n) ? n.join(", ") : String(n);
        (n = i(t, a)) && e.setHeader("Vary", n);
      }),
        (e.exports.append = i);
      var t = /^[!#$%&'*+\-.^_`|~0-9A-Za-z]+$/;
      function i(e, a) {
        ...
        for (
          var n = Array.isArray(a) ? a : o(String(a)), i = 0;
          i < n.length;
          i++
        )
          if (!t.test(n[i]))
        ...
        var r = e,
          s = o(e.toLowerCase());
        if (-1 !== n.indexOf("*") || -1 !== s.indexOf("*")) return "*";
        for (var c = 0; c < n.length; c++) {
          var p = n[c].toLowerCase();
          -1 === s.indexOf(p) && (s.push(p), (r = r ? r + ", " + n[c] : n[c]));
        }
        return r;
      }
      function o(e) {
    ...
    function (e, a, n) {
      ...
      (a = e.exports =
        t.function(function (e) {
          var n = {};
          if (e) for (var t in e) "type" !== t && (n[t] = e[t]);
          var i = a.urlencoded(n),
            o = a.json(n);
          return function (e, a, n) {
            o(e, a, function (t) {
              if (t) return n(t);
    ...
    function (e, a, n) {
       ...
       */ var t = n(12),
        i = n(18),
        o = n(9),
        r = n(21)("body-parser:json"),
        s = n(22),
        c = n(14);
      e.exports = function (e) {
        var a = e || {},
          n =
            "number" != typeof a.limit ? t.parse(a.limit || "100kb") : a.limit,
          u = !1 !== a.inflate,
          d = a.reviver,
          f = !1 !== a.strict,
          m = a.type || "application/json",
          v = a.verify || !1;
        ...
        function x(e) {
          ...
          if (f) {
            var a = ((n = e), (t = p.exec(n)) ? t[1] : void 0);
            if ("{" !== a && "[" !== a)
              throw (
                (r("strict violation"),
                (function (e, a) {
                  var n = e.indexOf(a),
                    t = -1 !== n ? e.substring(0, n) + "#" : "";
                  try {
                    throw (JSON.parse(t), new SyntaxError("strict violation"));
                  } catch (e) {
                    return l(e, {
        ...
        return function (e, a, t) {
          if (e._body) return r("body already parsed"), void t();
          if (((e.body = e.body || {}), !c.hasBody(e)))
            return r("skip empty body"), void t();
          if ((r("content-type %j", e.headers["content-type"]), !h(e)))
            return r("skip parsing"), void t();
          var p =
            (function (e) {
              try {
          ...
          s(e, a, t, x, r, { encoding: p, inflate: u, limit: n, verify: v });
        };
      };
      var p = /^[\x20\x09\x0a\x0d]*([^\x20\x09\x0a\x0d])/;
      function l(e, a) {
        for (var n = Object.getOwnPropertyNames(e), t = 0; t < n.length; t++) {
          var i = n[t];
    ...
    function (e, a, n) {
      var t = n(13),
        i = n(2);
      ((a = e.exports = n(40)).init = function (e) {
        e.inspectOpts = {};
        for (var n = Object.keys(a.inspectOpts), t = 0; t < n.length; t++)
        ...
        (a.formatArgs = function (e) {
          ...
          if (this.useColors) {
            var t = this.color,
              i = "  [3" + t + ";1m" + n + " [0m";
            (e[0] = i + e[0].split("\n").join("\n" + i)),
              e.push("[3" + t + "m+" + a.humanize(this.diff) + "[0m");
        ...
        1 === o
          ...
          : (function (e) {
              ...
              switch (process.binding("tty_wrap").guessHandleType(e)) {
                case "TTY":
                  ((a = new t.WriteStream(e))._type = "tty"),
                    a._handle && a._handle.unref && a._handle.unref();
                  break;
                case "FILE":
                  var i = n(0);
                  (a = new i.SyncWriteStream(e, { autoClose: !1 }))._type =
                    "fs";
                  break;
                case "PIPE":
                case "TCP":
    ...
    function (e, a, n) {
      ...
      e.exports = function (e, a, n) {
        var o = n,
          r = a || {};
        (!0 !== a && "string" != typeof a) || (r = { encoding: a });
        "function" == typeof a && ((o = a), (r = {}));
        if (void 0 !== o && "function" != typeof o)
          throw new TypeError("argument callback must be a function");
        if (!o && !global.Promise)
          throw new TypeError("argument callback is required");
        var s = !0 !== r.encoding ? r.encoding : "utf-8",
          c = i.parse(r.limit),
          p =
            null == r.length || isNaN(r.length) ? null : parseInt(r.length, 10);
        if (o)
          return l(
            e,
            s,
      ...
      function l(e, a, n, t, i) {
        ...
        function x(e) {
          if (!s) {
            ...
            else m(null, u ? f + (u.end() || "") : Buffer.concat(f));
          }
        }
        function b() {
          (f = null),
    ...
    function (e, a, n) {
      "use strict";
      for (
        var t = [n(83), n(85), n(86), n(87), n(88), n(89), n(90), n(91)], i = 0;
        i < t.length;
        i++
      ) {
        e = t[i];
    ...
    function (e, a, n) {
      ...
      (e.exports = {
        ...
        (i.prototype.decoder = r);
      var o = n(84).StringDecoder;
      function r(e, a) {
        o.call(this, a.enc);
      }
      function s(e, a) {
      ...
      o.prototype.end || (o.prototype.end = function () {}),
        ...
        (p.prototype.write = function (e) {
          for (var a = t.alloc(3 * e.length), n = 0, i = 0; i < e.length; i++) {
            var o = e.charCodeAt(i);
            o < 128
              ? (a[n++] = o)
              : o < 2048
              ? ((a[n++] = 192 + (o >>> 6)), (a[n++] = 128 + (63 & o)))
              : ((a[n++] = 224 + (o >>> 12)),
                (a[n++] = 128 + ((o >>> 6) & 63)),
                (a[n++] = 128 + (63 & o)));
          }
          ...
          for (
            ...
            128 != (192 & r)
              ...
              ? ((a = (a << 6) | (63 & r)),
                ...
                0 === --n &&
                  (i +=
                    (2 === t && a < 128 && a > 0) || (3 === t && a < 2048)
                      ? this.defaultCharUnicode
                      : String.fromCharCode(a)))
              : (i += this.defaultCharUnicode);
          }
          return (this.acc = a), (this.contBytes = n), (this.accBytes = t), i;
        }),
    ...
    function (e, a, n) {
      ...
      (a.utf16be = i),
        ...
        (o.prototype.write = function (e) {
          for (var a = t.from(e, "ucs2"), n = 0; n < a.length; n += 2) {
            var i = a[n];
            (a[n] = a[n + 1]), (a[n + 1] = i);
          }
          return a;
        ...
        (r.prototype.write = function (e) {
          if (0 == e.length) return "";
          var a = t.alloc(e.length + 1),
            n = 0,
            i = 0;
          for (
            -1 !== this.overflowByte &&
            ((a[0] = e[0]), (a[1] = this.overflowByte), (n = 1), (i = 2));
            n < e.length - 1;
            n += 2, i += 2
          )
            (a[i] = e[n + 1]), (a[i + 1] = e[n]);
    ...
    function (e, a, n) {
      ...
      (s.prototype.write = function (e) {
        for (
          var a = "", n = 0, i = this.inBase64, o = this.base64Accum, r = 0;
          r < e.length;
          r++
        )
          if (i) {
            if (!p[e[r]]) {
              if (r == n && e[r] == d) a += "+";
                ...
                a += this.iconv.decode(t.from(s, "base64"), "utf16-be");
              }
              e[r] != d && r--, (n = r + 1), (i = !1), (o = "");
            }
          } else
            e[r] == u &&
              ((a += this.iconv.decode(e.slice(n, r), "ascii")),
              (n = r + 1),
              (i = !0));
        if (i) {
          ...
          (o = s.slice(c)),
            (s = s.slice(0, c)),
            (a += this.iconv.decode(t.from(s, "base64"), "utf16-be"));
        } else a += this.iconv.decode(e.slice(n), "ascii");
        return (this.inBase64 = i), (this.base64Accum = o), a;
      }),
        (s.prototype.end = function () {
          var e = "";
          return (
            this.inBase64 &&
              ...
              (e = this.iconv.decode(
                t.from(this.base64Accum, "base64"),
                "utf16-be"
              )),
            (this.inBase64 = !1),
            (this.base64Accum = ""),
        ...
        (v.prototype.write = function (e) {
          ...
          return (this.inBase64 = a), (this.base64AccumIdx = i), o.slice(0, r);
        }),
    ...
    function (e, a, n) {
      ...
      function i(e, a) {
        ...
        var o = t.alloc(65536, a.defaultCharSingleByte.charCodeAt(0));
      ...
      (a._sbcs = i),
        ...
        (i.prototype.decoder = r),
        (o.prototype.write = function (e) {
          for (var a = t.alloc(e.length), n = 0; n < e.length; n++)
            a[n] = this.encodeBuf[e.charCodeAt(n)];
          return a;
        }),
        (o.prototype.end = function () {}),
        (r.prototype.write = function (e) {
          for (
            ...
            (i = 2 * e[r]), (n[(o = 2 * r)] = a[i]), (n[o + 1] = a[i + 1]);
    ...
    function (e, a, n) {
      ...
      var t = n(10).Buffer;
      a._dbcs = r;
      for (var i = new Array(256), o = 0; o < 256; o++) i[o] = -1;
      function r(e, a) {
        ...
        (this.decodeTables = []),
          ...
          (this.decodeTableSeq = []);
        for (var t = 0; t < n.length; t++) this._addDecodeChunk(n[t]);
        (this.defaultCharUnicode = a.defaultCharUnicode),
          (this.encodeTable = []),
          (this.encodeTableSeq = []);
        var o = {};
        if (e.encodeSkipVals)
          for (t = 0; t < e.encodeSkipVals.length; t++) {
            var r = e.encodeSkipVals[t];
            if ("number" == typeof r) o[r] = !0;
            else for (var s = r.from; s <= r.to; s++) o[s] = !0;
          }
        ...
        if (
          ...
          for (t = 129; t <= 254; t++) {
            var f = -1e3 - this.decodeTables[0][t],
              m = this.decodeTables[f];
            for (s = 48; s <= 57; s++) m[s] = -1e3 - p;
          }
          for (t = 129; t <= 254; t++) l[t] = -1e3 - u;
          for (t = 48; t <= 57; t++) d[t] = -2;
        }
      }
      function s(e, a) {
      ...
      function p(e, a) {
        if (e[0] > a) return -1;
        for (var n = 0, t = e.length; n < t - 1; ) {
          var i = n + Math.floor((t - n + 1) / 2);
          e[i] <= a ? (n = i) : (t = i);
        }
        return n;
      }
      (r.prototype.encoder = s),
        ...
        (r.prototype._getDecodeTrieNode = function (e) {
          ...
          0 == a.length && a.push(0);
          for (var n = this.decodeTables[0], t = a.length - 1; t > 0; t--) {
            var o = n[a[t]];
            if (-1 == o)
              (n[a[t]] = -1e3 - this.decodeTables.length),
            ...
            if ("string" == typeof i)
              for (var o = 0; o < i.length; ) {
                ...
                if (55296 <= r && r < 56320) {
                  ...
                  n[a++] = 65536 + 1024 * (r - 55296) + (s - 56320);
                } else if (4080 < r && r <= 4095) {
                  for (var c = 4095 - r + 2, p = [], l = 0; l < c; l++)
                    p.push(i.charCodeAt(o++));
                  (n[a++] = -10 - this.decodeTableSeq.length),
        ...
        (r.prototype._setEncodeChar = function (e, a) {
          var n = this._getEncodeBucket(e),
            t = 255 & e;
          n[t] <= -10
            ? (this.encodeTableSeq[-10 - n[t]][-1] = a)
            : -1 == n[t] && (n[t] = a);
        }),
        (r.prototype._setEncodeSequence = function (e, a) {
          var n,
            t = e[0],
            i = this._getEncodeBucket(t),
            o = 255 & t;
          i[o] <= -10
          ...
          for (var r = 1; r < e.length - 1; r++) {
            ...
            "object" == typeof s
              ? (n = s)
              : ((n = n[t] = {}), void 0 !== s && (n[-1] = s));
          }
          n[(t = e[e.length - 1])] = a;
        }),
        (r.prototype._fillEncodeTable = function (e, a, n) {
          for (var t = this.decodeTables[e], i = 0; i < 256; i++) {
            var o = t[i],
              r = a + i;
            n[r] ||
              (o >= 0
                ...
                : o <= -1e3
                ? this._fillEncodeTable(-1e3 - o, r << 8, n)
                : o <= -10 &&
        ...
        (s.prototype.write = function (e) {
          for (
            var a = t.alloc(e.length * (this.gb18030 ? 4 : 3)),
            ...
            if (void 0 !== i && -1 != c) {
              ...
              if (-1 == l && this.gb18030) {
                var f = p(this.gb18030.uChars, c);
                if (-1 != f) {
                  l = this.gb18030.gbChars[f] + (c - this.gb18030.uChars[f]);
          ...
          return (this.seqObj = i), (this.leadSurrogate = n), a.slice(0, s);
        }),
        (s.prototype.end = function () {
        ...
        (c.prototype.write = function (e) {
          var a = t.alloc(2 * e.length),
            n = this.nodeIdx,
            i = this.prevBuf,
            o = this.prevBuf.length,
            r = -this.prevBuf.length;
          o > 0 && (i = t.concat([i, e.slice(0, 10)]));
          for (var s = 0, c = 0; s < e.length; s++) {
            var l,
              u = s >= 0 ? e[s] : i[s + o];
            if ((l = this.decodeTables[n][u]) >= 0);
            else if (-1 === l)
              (s = r), (l = this.defaultCharUnicode.charCodeAt(0));
            else if (-2 === l) {
              var d = r >= 0 ? e.slice(r, s + 1) : i.slice(r + o, s + 1 + o),
                f =
                  12600 * (d[0] - 129) +
                  1260 * (d[1] - 48) +
                  10 * (d[2] - 129) +
                  (d[3] - 48),
                m = p(this.gb18030.gbChars, f);
              l = this.gb18030.uChars[m] + f - this.gb18030.gbChars[m];
            } else {
              if (l <= -1e3) {
                n = -1e3 - l;
                continue;
              ...
              for (
                var v = this.decodeTableSeq[-10 - l], h = 0;
                h < v.length - 1;
                h++
              )
                (l = v[h]), (a[c++] = 255 & l), (a[c++] = l >> 8);
              l = v[v.length - 1];
            }
            if (l > 65535) {
              l -= 65536;
              var x = 55296 + Math.floor(l / 1024);
              (a[c++] = 255 & x), (a[c++] = x >> 8), (l = 56320 + (l % 1024));
            }
            (a[c++] = 255 & l), (a[c++] = l >> 8), (n = 0), (r = s + 1);
          }
          return (
            (this.nodeIdx = n),
            (this.prevBuf = r >= 0 ? e.slice(r) : i.slice(r + o)),
    ...
    function (e, a, n) {
      ...
      var t = n(7).Buffer,
        i = n(5).Transform;
      function o(e, a) {
        (this.conv = e), ((a = a || {}).decodeStrings = !1), i.call(this, a);
      }
      function r(e, a) {
        (this.conv = e),
      ...
      (e.exports = function (e) {
        (e.encodeStream = function (a, n) {
          return new o(e.getEncoder(a, n), n);
        }),
          (e.decodeStream = function (a, n) {
            return new r(e.getDecoder(a, n), n);
          }),
          (e.supportsStreams = !0),
        ...
        (o.prototype._transform = function (e, a, n) {
          if ("string" != typeof e)
            return n(
        ...
        (r.prototype._transform = function (e, a, n) {
          if (!t.isBuffer(e))
            return n(
    ...
    function (e, a, n) {
      ...
      e.exports = function (e) {
        ...
        (e.supportsNodeEncodingsExtension = !(
          t.from || new t(0) instanceof Uint8Array
        )),
          (e.extendNodeEncodings = function () {
            if (!a) {
              ...
              t.isNativeEncoding = function (e) {
                return e && i[e.toLowerCase()];
              };
              var o = n(7).SlowBuffer;
              if (
                ((a.SlowBufferToString = o.prototype.toString),
                (o.prototype.toString = function (n, i, o) {
                  return (
                    (n = String(n || "utf8").toLowerCase()),
                    t.isNativeEncoding(n)
                      ? a.SlowBufferToString.call(this, n, i, o)
                      : (void 0 === i && (i = 0),
                        void 0 === o && (o = this.length),
                        e.decode(this.slice(i, o), n))
                  );
                }),
                (a.SlowBufferWrite = o.prototype.write),
                (o.prototype.write = function (n, i, o, r) {
                  if (isFinite(i)) isFinite(o) || ((r = o), (o = void 0));
                  else {
                    var s = r;
                    (r = i), (i = o), (o = s);
                  }
                  ...
                  if (
                    ...
                    t.isNativeEncoding(r))
                  )
                    return a.SlowBufferWrite.call(this, n, i, o, r);
                  ...
                  var p = e.encode(n, r);
                  return (
                    p.length < o && (o = p.length), p.copy(this, i, 0, o), o
                  );
                }),
                (a.BufferIsEncoding = t.isEncoding),
                (t.isEncoding = function (a) {
                  return t.isNativeEncoding(a) || e.encodingExists(a);
                }),
                (a.BufferByteLength = t.byteLength),
                (t.byteLength = o.byteLength =
                  function (n, i) {
                    return (
                      (i = String(i || "utf8").toLowerCase()),
                      t.isNativeEncoding(i)
                        ? a.BufferByteLength.call(this, n, i)
                        : e.encode(n, i).length
                    );
                  }),
                (a.BufferToString = t.prototype.toString),
                (t.prototype.toString = function (n, i, o) {
                  return (
                    (n = String(n || "utf8").toLowerCase()),
                    t.isNativeEncoding(n)
                      ? a.BufferToString.call(this, n, i, o)
                      : (void 0 === i && (i = 0),
                        void 0 === o && (o = this.length),
                        e.decode(this.slice(i, o), n))
                  );
                }),
                (a.BufferWrite = t.prototype.write),
                (t.prototype.write = function (n, i, o, r) {
                  var s = i,
                    c = o,
                    p = r;
                  if (isFinite(i)) isFinite(o) || ((r = o), (o = void 0));
                  ...
                  if (
                    ...
                    return a.BufferWrite.call(this, n, s, c, p);
                  i = +i || 0;
                  var u = this.length - i;
                  if (
                    (o ? (o = +o) > u && (o = u) : (o = u),
                  ...
                  var d = e.encode(n, r);
                  return (
                    d.length < o && (o = d.length), d.copy(this, i, 0, o), o
                  );
                }),
                e.supportsStreams)
              ) {
                ...
                (a.ReadableSetEncoding = r.prototype.setEncoding),
                  (r.prototype.setEncoding = function (a, n) {
                    (this._readableState.decoder = e.getDecoder(a, n)),
          ...
          (e.undoExtendNodeEncodings = function () {
            if (e.supportsNodeEncodingsExtension) {
              ...
              var i = n(7).SlowBuffer;
              if (
                ((i.prototype.toString = a.SlowBufferToString),
                (i.prototype.write = a.SlowBufferWrite),
                (t.isEncoding = a.BufferIsEncoding),
                (t.byteLength = a.BufferByteLength),
                (t.prototype.toString = a.BufferToString),
                (t.prototype.write = a.BufferWrite),
                e.supportsStreams)
              ) {
                var o = n(5).Readable;
      ...
      e.exports = function (e, a) {
        ...
        for (var n = [], i = 0; i < e.length; i++) {
          ...
          for (var r = o[0], s = 1; s < o.length; s++) {
            var c = o[s],
              p = t(c, l);
            r.on(c, p), n.push({ ee: r, event: c, fn: p });
          }
        }
        function l() {
        ...
        function u() {
          for (var e, a = 0; a < n.length; a++)
            (e = n[a]).ee.removeListener(e.event, e.fn);
        }
        function d(e) {
          a = e;
        }
    ...
    function (e, a) {
      ...
      (a.format = function (e) {
        ...
        var r = o + "/" + n;
        if (t) {
          if (!c.test(t)) throw new TypeError("invalid suffix");
          r += "+" + t;
        }
        if (a && "object" == typeof a)
          ...
          var a,
            ...
            s = (function (e) {
              ...
              var n,
                ...
                i = a[2],
                o = i.lastIndexOf("+");
              -1 !== o && ((n = i.substr(o + 1)), (i = i.substr(0, o)));
              return { type: t, subtype: i, suffix: n };
            })(-1 !== r ? e.substr(0, r) : e),
            c = {};
          n.lastIndex = r;
          for (; (t = n.exec(e)); ) {
            if (t.index !== r) throw new TypeError("invalid parameter format");
            (r += t[0].length),
              (a = t[1].toLowerCase()),
              '"' === (i = t[2])[0] &&
                (i = i.substr(1, i.length - 2).replace(o, "$1")),
              (c[a] = i);
          }
          if (-1 !== r && r !== e.length)
            throw new TypeError("invalid parameter format");
              ...
              r.hasBody(e)
                ? (i("content-type %j", e.headers["content-type"]),
                  l(e)
                    ...
                    : (i("skip parsing"), void t()))
                : (i("skip empty body"), void t()));
        };
      };
    },
    function (e, a, n) {
       ...
       */ var t = n(12),
        i = n(18),
        o = n(21)("body-parser:text"),
        r = n(22),
        s = n(14);
      e.exports = function (e) {
        var a = e || {},
          n = a.defaultCharset || "utf-8",
          c = !1 !== a.inflate,
          p =
            "number" != typeof a.limit ? t.parse(a.limit || "100kb") : a.limit,
          l = a.type || "text/plain",
        ...
        return function (e, a, t) {
          if (e._body) return o("body already parsed"), void t();
          if (((e.body = e.body || {}), !s.hasBody(e)))
            return o("skip empty body"), void t();
          if ((o("content-type %j", e.headers["content-type"]), !d(e)))
            return o("skip parsing"), void t();
          var l =
            (function (e) {
              try {
                return (i.parse(e).parameters.charset || "").toLowerCase();
          ...
          r(e, a, t, f, o, { encoding: l, inflate: c, limit: p, verify: u });
        };
      };
    },
    function (e, a, n) {
      ...
      e.exports = function (e) {
        ...
        var n = !1 !== a.extended,
          ...
          f =
            "number" != typeof a.limit ? t.parse(a.limit || "100kb") : a.limit,
          m = a.type || "application/x-www-form-urlencoded",
          v = a.verify || !1;
        if (!1 !== v && "function" != typeof v)
          throw new TypeError("option verify must be function");
        var h = n
            ...
            : (function (e) {
                ...
                return function (e) {
                  ...
                  return (
                    r("parse urlencoding"), n(e, void 0, void 0, { maxKeys: a })
                  );
                };
              })(a),
          x =
        ...
        return function (e, a, n) {
          ...
          if ("utf-8" !== t)
            return (
              r("invalid charset"),
              void n(
                o(415, 'unsupported charset "' + t.toUpperCase() + '"', {
                  charset: t,
                  type: "charset.unsupported",
                })
              )
      ...
      function u(e, a) {
        for (var n = 0, t = 0; -1 !== (t = e.indexOf("&", t)); )
          if ((t++, ++n === a)) return;
        return n;
      }
      function d(e) {
    ...
    function (e, a, n) {
      ...
      var t = n(106),
        ...
        v = {},
        h = function e(a, n, o, r, s, l, d, f, h, x, b, g, y, w, k) {
          for (
            var E, O = a, S = k, j = 0, C = !1;
            void 0 !== (S = S.get(v)) && !C;
          ...
          if (
            ...
            if (r) return l && !y ? l(n, m.encoder, w, "key", b) : n;
            O = "";
          }
          if (
            "string" == typeof (E = O) ||
            ...
            if (l) {
              var I = y ? n : l(n, m.encoder, w, "key", b);
              if ("comma" === o && y) {
                for (
                  var _ = p.call(String(O), ","), A = "", q = 0;
                  q < _.length;
                  ++q
                )
                  A +=
                    (0 === q ? "" : ",") + g(l(_[q], m.encoder, w, "value", b));
                return [g(I) + "=" + A];
              }
              return [g(I) + "=" + g(l(O, m.encoder, w, "value", b))];
            }
            return [g(n) + "=" + g(String(O))];
          }
          var z,
            P = [];
          ...
          for (var K = 0; K < z.length; ++K) {
            var N = z[K],
              L = "object" == typeof N && void 0 !== N.value ? N.value : O[N];
            if (!s || null !== L) {
              var U = c(O)
                ? "function" == typeof o
                  ? o(n, N)
              ...
              k.set(a, j);
              var F = t();
              F.set(v, k), u(P, e(L, U, o, r, s, l, d, f, h, x, b, g, y, w, F));
            }
          }
          return P;
        };
      e.exports = function (e, a) {
        ...
        for (var v = t(), x = 0; x < n.length; ++x) {
          var b = n[x];
          (p.skipNulls && null === i[b]) ||
            u(
              d,
              h(
                i[b],
    ...
    function (e, a, n) {
      ...
      var t = n(32),
        ...
        v = function (e, a) {
          for (var n, t = e; null !== (n = t.next); t = n)
            if (n.key === a)
              ...
              s && t && ("object" == typeof t || "function" == typeof t)
                ...
                : (n || (n = { key: {}, next: null }),
                  (function (e, a, n) {
                    ...
                    t
                      ? (t.value = n)
                      : (e.next = { key: a, next: e.next, value: n });
                  })(n, t, i));
            },
          };
        return t;
    ...
    function (e, a, n) {
      ...
      e.exports = function () {
        ...
        if (1 !== t.length || t[0] !== a) return !1;
        if (!Object.prototype.propertyIsEnumerable.call(e, a)) return !1;
    ...
    function (e, a, n) {
      ...
      e.exports = function (e) {
        var a = this;
        if ("function" != typeof a || "[object Function]" !== o.call(a))
          ...
          var n,
            ...
            s = function () {
              if (this instanceof n) {
                var t = a.apply(this, r.concat(i.call(arguments)));
                return Object(t) === t ? t : this;
              }
              return a.apply(e, r.concat(i.call(arguments)));
            },
    ...
    function (e, a, n) {
      ...
      var t = n(32),
        i = n(112),
        o = i(t("String.prototype.indexOf"));
      e.exports = function (e, a) {
        var n = t(e, !!a);
    ...
    function (e, a, n) {
      ...
      var t = n(33),
        ...
        s = i("%Reflect.apply%", !0) || t.call(r, o),
    ...
    function (e, a, n) {
      var t = "function" == typeof Map && Map.prototype,
        i =
          Object.getOwnPropertyDescriptor && t
            ...
            : null,
        o = t && i && "function" == typeof i.get ? i.get : null,
        ...
        A =
          "function" == typeof Symbol &&
          Symbol.toStringTag &&
          (typeof Symbol.toStringTag === _ || "symbol")
            ? Symbol.toStringTag
            : null,
      ...
      e.exports = function e(a, n, t, i) {
        ...
        var c = !D(s, "customInspect") || s.customInspect;
        ...
        if (D(s, "numericSeparator") && "boolean" != typeof s.numericSeparator)
          throw new TypeError(
        ...
        if ("string" == typeof a)
          return (function e(a, n) {
            if (a.length > n.maxStringLength) {
              var t = a.length - n.maxStringLength,
                i = "... " + t + " more character" + (t > 1 ? "s" : "");
              return e(b.call(a, 0, n.maxStringLength), n) + i;
            }
            return N(
              g.call(g.call(a, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, $),
              "single",
              n
            );
          })(a, s);
        if ("number" == typeof a) {
          if (0 === a) return 1 / 0 / a > 0 ? "0" : "-0";
          var y = String(a);
          return v ? P(a, y) : y;
        }
        if ("bigint" == typeof a) {
        ...
        if ((void 0 === t && (t = 0), t >= j && j > 0 && "object" == typeof a))
          return U(a) ? "[Array]" : "[Object]";
        var T = (function (e, a) {
          var n;
          if ("\t" === e.indent) n = "\t";
          else {
          ...
          return { base: n, prev: O.call(Array(a + 1), n) };
        })(s, t);
        if (void 0 === i) i = [];
        else if (H(i, a) >= 0) return "[Circular]";
        function B(a, n, o) {
          if ((n && (i = S.call(i)).push(n), o)) {
            var r = { depth: s.depth };
            return (
              D(s, "quoteStyle") && (r.quoteStyle = s.quoteStyle),
              e(a, r, t + 1, i)
            );
          }
          return e(a, s, t + 1, i);
        ...
        if ("function" == typeof a) {
          var M = (function (e) {
              ...
              var a = x.call(h.call(e), /^function\s*([\w$]+)/);
              if (a) return a[1];
              return null;
            })(a),
            Q = Z(a, B);
        ...
        if (F(a)) {
          var Y = _
            ...
            : I.call(a);
          return "object" != typeof a || _ ? Y : G(Y);
        }
        if (
          (function (e) {
          ...
          for (
            var X = "<" + w.call(String(a.nodeName)),
              ee = a.attributes || [],
              ae = 0;
            ae < ee.length;
            ae++
          )
            X += " " + ee[ae].name + "=" + N(L(ee[ae].value), "double", s);
          return (
            (X += ">"),
            a.childNodes && a.childNodes.length && (X += "..."),
            (X += "</" + w.call(String(a.nodeName)) + ">")
          );
        }
        if (U(a)) {
        ...
        if (
          ...
          var te = Z(a, B);
          return "cause" in a && !q.call(a, "cause")
            ? "{ [" +
                String(a) +
                "] " +
                O.call(E.call("[cause]: " + B(a.cause), te), ", ") +
                " }"
            : 0 === te.length
            ? "[" + String(a) + "]"
            : "{ [" + String(a) + "] " + O.call(te, ", ") + " }";
        ...
        if ("object" == typeof a && c) {
          if (K && "function" == typeof a[K]) return a[K]();
          if ("symbol" !== c && "function" == typeof a.inspect)
            return a.inspect();
        }
        if (
          (function (e) {
          ...
          var ie = [];
          return (
            r.call(a, function (e, n) {
              ie.push(B(n, a, !0) + " => " + B(e, a));
            }),
            V("Map", o.call(a), ie, T)
          );
        }
        ...
        if (
          ...
          var re = Z(a, B),
            ...
            ce = a instanceof Object ? "" : "null prototype",
            pe =
              !se && A && Object(a) === a && A in a
                ? b.call(R(a), 8, -1)
                : ce
                ? "Object"
                : "",
            le =
              (se || "function" != typeof a.constructor
                ? ""
                : a.constructor.name
                ? a.constructor.name + " "
                : "") +
      ...
      function Z(e, a) {
        ...
        if (n) {
          t.length = e.length;
          for (var i = 0; i < e.length; i++) t[i] = D(e, i) ? a(e[i], e) : "";
        }
        var o,
        ...
        for (var c in e)
          D(e, c) &&
            ((n && String(Number(c)) === c && c < e.length) ||
              ...
              (k.call(/[^\w$]/, c)
                ? t.push(a(c, e) + ": " + a(e[c], e))
                : t.push(c + ": " + a(e[c], e))));
        if ("function" == typeof T)
          for (var p = 0; p < r.length; p++)
            q.call(e, r[p]) && t.push("[" + a(r[p]) + "]: " + a(e[r[p]], e));
        return t;
      }
    },
    function (e, a, n) {
      e.exports = n(2).inspect;
    },
    function (e, a, n) {
      "use strict";
      var t = n(47),
        ...
        c = function (e, a) {
          return e && "string" == typeof e && a.comma && e.indexOf(",") > -1
            ? e.split(",")
            : e;
        },
        p = function (e, a, n, t) {
          if (e) {
            ...
            return (
              ...
              (function (e, a, n, t) {
                for (var i = t ? a : c(a, n), o = e.length - 1; o >= 0; --o) {
                  var r,
                    s = e[o];
                  if ("[]" === s && n.parseArrays) r = [].concat(i);
                  else {
      ...
      e.exports = function (e, a) {
        var n = (function (e) {
          ...
          var a = void 0 === e.charset ? r.charset : e.charset;
          return {
            ...
            allowPrototypes:
              "boolean" == typeof e.allowPrototypes
                ...
                : r.allowPrototypes,
            allowSparse:
              "boolean" == typeof e.allowSparse ? e.allowSparse : r.allowSparse,
            arrayLimit:
            ...
            delimiter:
              "string" == typeof e.delimiter || t.isRegExp(e.delimiter)
                ? e.delimiter
                : r.delimiter,
            depth:
              "number" == typeof e.depth || !1 === e.depth ? +e.depth : r.depth,
        ...
        for (
          var l =
              "string" == typeof e
                ? (function (e, a) {
                    var n,
                      p = {},
                      l = a.ignoreQueryPrefix ? e.replace(/^\?/, "") : e,
                      u =
                        a.parameterLimit === 1 / 0 ? void 0 : a.parameterLimit,
                      d = l.split(a.delimiter, u),
                      f = -1,
                      m = a.charset;
                    ...
                    for (n = 0; n < d.length; ++n)
                      if (n !== f) {
                        var v,
                          ...
                          g = -1 === b ? x.indexOf("=") : b + 1;
                        -1 === g
                          ? ((v = a.decoder(x, r.decoder, m, "key")),
                            (h = a.strictNullHandling ? null : ""))
                          : ((v = a.decoder(
                              x.slice(0, g),
                              r.decoder,
                              m,
                            ...
                            (h = t.maybeMap(c(x.slice(g + 1), a), function (e) {
                              return a.decoder(e, r.decoder, m, "value");
                            }))),
                          h &&
                            a.interpretNumericEntities &&
                            "iso-8859-1" === m &&
                            (h = s(h)),
                          x.indexOf("[]=") > -1 && (h = o(h) ? [h] : h),
                          i.call(p, v)
                            ? (p[v] = t.combine(p[v], h))
                            : (p[v] = h);
                      }
          ...
          var m = d[f],
            v = p(m, l[m], n, "string" == typeof e);
          u = t.merge(u, v, n);
        }
        return !0 === n.allowSparse ? u : t.compact(u);
      };
    },
    function (e, a, n) {
      "use strict";
    ...
    function (e, a, n) {
       ...
       */ var t = n(118),
        ...
        r = n(127),
        s = n(54),
        c = n(16)("express:application"),
        p = n(128),
        l = n(8),
        u = n(6).compileETag,
        d = n(6).compileQueryParser,
        f = n(6).compileTrust,
        m = n(3)("express"),
        v = n(26),
        h = n(27),
      ...
      (w.init = function () {
        ...
        (w.handle = function (e, a, n) {
          var i = this._router,
            o = n || t(e, a, { env: this.get("env"), onerror: k.bind(this) });
          if (!i) return c("no routes defined on app"), void o();
          i.handle(e, a, o);
        }),
        (w.use = function (e) {
          var a = 0,
          ...
          return (
            i.forEach(function (e) {
              ...
              c(".use app under %s", n),
                (e.mountpath = n),
                (e.parent = this),
                o.use(n, function (a, n, t) {
                  var i = a.app;
                  e.handle(a, n, function (e) {
                    b(a, i.request), b(n, i.response), t(e);
                  });
                }),
                e.emit("mount", this);
            }, this),
        ...
        (w.engine = function (e, a) {
          ...
          var n = "." !== e[0] ? "." + e : e;
          return (this.engines[n] = a), this;
        }),
        (w.param = function (e, a) {
          if ((this.lazyrouter(), Array.isArray(e))) {
            for (var n = 0; n < e.length; n++) this.param(e[n], a);
            return this;
          }
        ...
        (w.all = function (e) {
          this.lazyrouter();
          for (
            var a = this._router.route(e), n = y.call(arguments, 1), t = 0;
            t < o.length;
            t++
          )
            a[o[t]].apply(a, n);
        ...
        (w.render = function (e, a, n) {
          var t,
            ...
            c = {};
          if (
            ("function" == typeof a && ((o = a), (s = {})),
            h(c, this.locals),
            s._locals && h(c, s._locals),
            h(c, s),
            ...
            if (
              ...
              var p =
                  Array.isArray(t.root) && t.root.length > 1
                    ? 'directories "' +
                      t.root.slice(0, -1).join('", "') +
                      '" or "' +
                      t.root[t.root.length - 1] +
                      '"'
                    : 'directory "' + t.root + '"',
                l = new Error(
        ...
        return function (n) {
          ...
          if (n || !m(a)) {
            if (
              ...
              return (
                t("cannot %d after headers sent", g), void e.socket.destroy()
              );
            !(function (e, a, n, t, i) {
              function s() {
                var r = (function (e) {
                ...
                (a.statusCode = n),
                  ...
                  "HEAD" !== e.method ? a.end(r, "utf8") : a.end();
              }
              if (f(e)) return void s();
              p(e), r(e, s), e.resume();
            })(e, a, g, v, b);
          } else t("cannot 404 after headers sent");
        };
      };
    },
    function (e, a, n) {
    ...
    function (e, a, n) {
      var t = n(13),
        i = n(2);
      ((a = e.exports = n(49)).init = function (e) {
        e.inspectOpts = {};
        for (var n = Object.keys(a.inspectOpts), t = 0; t < n.length; t++)
          e.inspectOpts[n[t]] = a.inspectOpts[n[t]];
      }),
    ...
    function (e, a, n) {
      var t = n(13),
        i = n(2);
      ((a = e.exports = n(52)).init = function (e) {
        e.inspectOpts = {};
        for (var n = Object.keys(a.inspectOpts), t = 0; t < n.length; t++)
          e.inspectOpts[n[t]] = a.inspectOpts[n[t]];
      }),
    ...
    function (e, a) {
      e.exports = function e(a, t, i) {
        ...
        if (a instanceof RegExp) {
          for (; (o = n.exec(a.source)); )
            t.push({ name: d++, optional: !1, offset: o.index });
          return a;
        }
        if (Array.isArray(a))
          return (
            (a = a.map(function (a) {
              return e(a, t, i).source;
            })),
            new RegExp("(?:" + a.join("|") + ")", c)
          );
        a = ("^" + a + (r ? "" : "/" === a[a.length - 1] ? "?" : "/?"))
          ...
          .replace(
            /(\\\/)?(\\\.)?:(\w+)(\(.*?\))?(\*)?(\?)?/g,
            function (e, a, n, i, o, r, s, c) {
              (a = a || ""),
                (n = n || ""),
                (o = o || "([^\\/" + n + "]+?)"),
                (s = s || ""),
                t.push({ name: i, optional: !!s, offset: c + p });
              var l =
                (s ? "" : a) +
                "(?:" +
                n +
          ...
          .replace(/\*/g, function (e, a) {
            for (var n = t.length; n-- > l && t[n].offset > a; )
              t[n].offset += 3;
            return "(.*)";
          });
        for (; (o = n.exec(a)); ) {
          for (var f = 0, m = o.index; "\\" === a.charAt(--m); ) f++;
          f % 2 != 1 &&
            ((l + u === t.length || t[l + u].offset > o.index) &&
              t.splice(l + u, 0, { name: d++, optional: !1, offset: o.index }),
            u++);
        }
        return (
          (a += s ? "$" : "/" === a[a.length - 1] ? "" : "(?=\\/|$)"),
    ...
    function (e, a, n) {
      ...
      function u(e, a) {
        ...
        (this.engine = i.engines[this.ext]), (this.path = this.lookup(o));
      }
      function d(e) {
        t('stat "%s"', e);
        try {
      ...
      (e.exports = u),
        ...
        (u.prototype.render = function (e, a) {
          t('render "%s"', this.path), this.engine(this.path, e, a);
        }),
        (u.prototype.resolve = function (e, a) {
          var n = this.ext,
            ...
            i = d(t);
          return (i && i.isFile()) ||
            ((i = d((t = p(e, s(a, n), "index" + n)))) && i.isFile())
            ? t
            : void 0;
        });
    },
    ...
    function (e, a, n) {
      var t = n(13),
        i = n(2);
      ((a = e.exports = n(56)).init = function (e) {
        e.inspectOpts = {};
        for (var n = Object.keys(a.inspectOpts), t = 0; t < n.length; t++)
          e.inspectOpts[n[t]] = a.inspectOpts[n[t]];
      }),
    ...
    function (e, a, n) {
      ...
      (i.prototype.define = function (e) {
        for (var a in e) {
          for (var n = e[a], t = 0; t < n.length; t++)
            process.env.DEBUG_MIME &&
              ...
              (this.types[n[t]] = a);
          this.extensions[a] || (this.extensions[a] = n[0]);
        }
      }),
        ...
        (i.prototype.lookup = function (e, a) {
          var n = e.replace(/^.*[\.\/\\]/, "").toLowerCase();
          return this.types[n] || a || this.default_type;
        }),
    ...
    function (e, a, n) {
      ...
      e.exports = function (e) {
        ...
        var a = (function (e) {
          for (
            var a = e.length, n = [], t = e.length, i = e.length - 1;
            i >= 0;
            i--
          )
            switch (e.charCodeAt(i)) {
              case 32:
                ...
                break;
              case 44:
                t !== a && n.push(e.substring(t, a)), (t = a = i);
                break;
              default:
                t = i;
            }
        ...
        (function () {
          ...
          (n = {}),
            ...
            (s = function (e, a, n, t) {
              ...
              for (i = 0; t > 0; ) {
                if (((o = n - t) < 0 && (o = 0), e[i] >> o != a[i] >> o))
                  return !1;
                (t -= n), (i += 1);
              }
              return !0;
            }),
            (n.subnetMatch = function (e, a, n) {
              var t, i, o, r, s;
              for (o in (null == n && (n = "unicast"), a))
                for (
              ...
              return (
                ...
                (e.prototype.prefixLengthFromSubnetMask = function () {
                  ...
                  for (
                    ...
                    if (!((t = this.octets[a]) in r)) return null;
                    if (((o = r[t]), i && 0 !== o)) return null;
                    8 !== o && (i = !0), (e += o);
                  }
                  return 32 - e;
                }),
            ...
            (n.IPv4.parser = function (e) {
              ...
              if (
                ...
                (a = e.match(i.fourOctet)))
              )
                return (function () {
                  var e, i, o, r;
                  for (
                    r = [], e = 0, i = (o = a.slice(1, 6)).length;
                    e < i;
                    e++
                  )
                    (t = o[e]), r.push(n(t));
              ...
              if ((a = e.match(i.longValue))) {
                if ((r = n(a[1])) > 4294967295 || r < 0)
            ...
            (n.IPv6 = (function () {
              function e(e, a) {
                var n, t, i, o, r, s;
                if (16 === e.length)
                  for (this.parts = [], n = t = 0; t <= 14; n = t += 2)
              ...
              return (
                ...
                (e.prototype.toRFC5952String = function () {
                  ...
                  for (
                    ...
                    n[0].length > a && ((e = n.index), (a = n[0].length));
                  return a < 0
                    ? i
                    : i.substring(0, e) + "::" + i.substring(e + a);
                }),
                (e.prototype.toByteArray = function () {
                  var e, a, n, t, i;
                  for (e = [], a = 0, n = (i = this.parts).length; a < n; a++)
                    (t = i[a]), e.push(t >> 8), e.push(255 & t);
                  return e;
                }),
                (e.prototype.toNormalizedString = function () {
                  var e, a, n;
                  return (
                    (e = function () {
                      var e, n, t, i;
                      for (
                        i = [], e = 0, n = (t = this.parts).length;
                        e < n;
                        e++
                      )
                        (a = t[e]), i.push(a.toString(16));
                      return i;
                    }
                      .call(this)
                      .join(":")),
                  ...
                  return (
                    (e = function () {
                      ...
                      for (
                        ...
                        (a = t[e]), i.push(a.toString(16).padStart(4, "0"));
                      return i;
                    }
                      .call(this)
                      .join(":")),
                ...
                (e.prototype.toIPv4Address = function () {
                  ...
                  return (
                    (e = (t = this.parts.slice(-2))[0]),
                    (a = t[1]),
                    new n.IPv4([e >> 8, 255 & e, a >> 8, 255 & a])
                  );
                }),
                (e.prototype.prefixLengthFromSubnetMask = function () {
                  var e, a, n, t, i, o, r;
                  for (
                    ...
                    if (!((t = this.parts[a]) in r)) return null;
                    if (((o = r[t]), i && 0 !== o)) return null;
                    16 !== o && (i = !0), (e += o);
                  }
                  return 128 - e;
              ...
              return (
                ...
                ":" === e[e.length - 1] && (e = e.slice(0, -1)),
                {
                  parts: (a = (function () {
                    var a, n, t, o;
                    for (
                      o = [], a = 0, n = (t = e.split(":")).length;
                      a < n;
                      a++
                    )
                      (i = t[a]), o.push(parseInt(i, 16));
                    return o;
                  })()),
                  zoneId: c,
                }
            ...
            (n.IPv6.parser = function (e) {
              var n, t, i, o, s, c, p;
              if (r.native.test(e)) return a(e, 8);
              if (
                (o = e.match(r.transitional)) &&
                ((p = o[6] || ""), (n = a(o[1].slice(0, -1) + p, 6)).parts)
              ) {
                for (
                  t = 0,
                    i = (c = [
            ...
            (n.IPv4.subnetMaskFromPrefixLength = function (e) {
              ...
              for (t = [0, 0, 0, 0], n = 0, a = Math.floor(e / 8); n < a; )
                (t[n] = 255), n++;
              return (
                a < 4 && (t[a] = (Math.pow(2, e % 8) - 1) << (8 - (e % 8))),
                new this(t)
              );
            }),
            (n.IPv4.broadcastAddressFromCIDR = function (e) {
              ...
              try {
                for (
                  t = (a = this.parseCIDR(e))[0].toByteArray(),
                  ...
                  i.push(parseInt(t[n], 10) | (255 ^ parseInt(o[n], 10))), n++;
                return new this(i);
              } catch (e) {
                throw (
                  (e,
            ...
            (n.IPv4.networkAddressFromCIDR = function (e) {
              ...
              try {
                for (
                  ...
                  i.push(parseInt(t[n], 10) & parseInt(o[n], 10)), n++;
                return new this(i);
              } catch (e) {
                throw (
                  (e,
            ...
            (n.fromByteArray = function (e) {
              var a;
              if (4 === (a = e.length)) return new n.IPv4(e);
              if (16 === a) return new n.IPv6(e);
              throw new Error(
      ...
      (e.exports = d),
        ...
        (d.param = function (e, a) {
          var n = this.params || {},
            t = this.body || {},
            o = this.query || {},
            r = 1 === arguments.length ? "name" : "name, default";
          return (
            i(
              "req.param(" +
                r +
        ...
        f(d, "protocol", function () {
          ...
          var a = this.get("X-Forwarded-Proto") || e,
            n = a.indexOf(",");
          return -1 !== n ? a.substring(0, n).trim() : a.trim();
        }),
        f(d, "secure", function () {
        ...
        f(d, "hostname", function () {
          ...
          if (
            ...
            var n = "[" === a[0] ? a.indexOf("]") + 1 : 0,
              t = a.indexOf(":", n);
            return -1 !== t ? a.substring(0, t) : a;
          }
        }),
        f(
          d,
    ...
    function (e, a, n) {
      ...
      (e.exports = s),
        ...
        (s.prototype.charsets = function (e) {
          return t(this.request.headers["accept-charset"], e);
        }),
    ...
    function (e, a, n) {
      ...
      function i(e, a) {
        ...
        return { charset: i, q: o, i: a };
      }
      function o(e, a, n) {
        var t = 0;
        if (a.charset.toLowerCase() === e.toLowerCase()) t |= 1;
        else if ("*" !== a.charset) return null;
        return { i: n, o: a.i, q: a.q, s: t };
      }
      function r(e, a) {
        var n = (function (e) {
          for (var a = e.split(","), n = 0, t = 0; n < a.length; n++) {
            var o = i(a[n].trim(), n);
            o && (a[t++] = o);
          }
          return (a.length = t), a;
        })(void 0 === e ? "*" : e || "");
        if (!a) return n.filter(p).sort(s).map(c);
        var t = a.map(function (e, a) {
          return (function (e, a, n) {
            for (var t = { o: -1, q: 0, s: 0 }, i = 0; i < a.length; i++) {
              var r = o(e, a[i], n);
    ...
    function (e, a, n) {
      ...
      function i(e, a) {
        ...
        return { encoding: i, q: o, i: a };
      }
      function o(e, a, n) {
        var t = 0;
        if (a.encoding.toLowerCase() === e.toLowerCase()) t |= 1;
      ...
      function r(e, a) {
        var n = (function (e) {
          ...
          return (
            n || (a[s++] = { encoding: "identity", q: t, i: r }),
            (a.length = s),
            a
          );
        })(e || "");
    ...
    function (e, a, n) {
      ...
      function i(e, a) {
        ...
        return { prefix: i, suffix: o, q: s, i: a, full: r };
      }
      function o(e, a, n) {
        var t = i(e);
        if (!t) return null;
        var o = 0;
        if (a.full.toLowerCase() === t.full.toLowerCase()) o |= 4;
        else if (a.prefix.toLowerCase() === t.full.toLowerCase()) o |= 2;
        else if (a.full.toLowerCase() === t.prefix.toLowerCase()) o |= 1;
        else if ("*" !== a.full) return null;
        return { i: n, o: a.i, q: a.q, s: o };
      }
      function r(e, a) {
        var n = (function (e) {
          for (var a = e.split(","), n = 0, t = 0; n < a.length; n++) {
    ...
    function (e, a, n) {
      ...
      function i(e) {
        for (
          var a = (function (e) {
              for (var a = e.split(","), n = 1, t = 0; n < a.length; n++)
                u(a[t]) % 2 == 0 ? (a[++t] = a[n]) : (a[t] += "," + a[n]);
              return (a.length = t + 1), a;
            })(e),
            n = 0,
            t = 0;
          n < a.length;
      ...
      function o(e, a) {
          ...
          for (
            var c = (function (e) {
                for (var a = e.split(";"), n = 1, t = 0; n < a.length; n++)
                  u(a[t]) % 2 == 0 ? (a[++t] = a[n]) : (a[t] += ";" + a[n]);
                a.length = t + 1;
                for (n = 0; n < a.length; n++) a[n] = a[n].trim();
                return a;
              })(n[3]).map(d),
              p = 0;
            p < c.length;
        ...
        return { type: s, subtype: r, params: i, q: o, i: a };
      }
      function r(e, a, n) {
        var t = o(e),
          i = 0;
        if (!t) return null;
        if (a.type.toLowerCase() == t.type.toLowerCase()) i |= 4;
        else if ("*" != a.type) return null;
        if (a.subtype.toLowerCase() == t.subtype.toLowerCase()) i |= 2;
        else if ("*" != a.subtype) return null;
        var r = Object.keys(a.params);
        if (r.length > 0) {
          if (
            !r.every(function (e) {
              return (
        ...
        return { i: n, o: a.i, q: a.q, s: i };
      }
      function s(e, a) {
        var n = i(void 0 === e ? "*/*" : e || "");
        if (!a) return n.filter(l).sort(c).map(p);
        var t = a.map(function (e, a) {
          return (function (e, a, n) {
            for (var t = { o: -1, q: 0, s: 0 }, i = 0; i < a.length; i++) {
              var o = r(e, a[i], n);
              o && (t.s - o.s || t.q - o.q || t.o - o.o) < 0 && (t = o);
            }
            return t;
          })(e, n, a);
        });
      ...
      function u(e) {
        for (var a = 0, n = 0; -1 !== (n = e.indexOf('"', n)); ) a++, n++;
        return a;
      }
      function d(e) {
        var a,
          ...
          t = e.indexOf("=");
        return (
          -1 === t ? (a = e) : ((a = e.substr(0, t)), (n = e.substr(t + 1))),
          [a, n]
        );
      }
    },
    function (e, a, n) {
       ...
       */ var t = n(36).Buffer,
        ...
        E = d.resolve,
        O = n(66),
        S = Object.create(p.ServerResponse.prototype);
      e.exports = S;
      var j = /;\s*charset\s*=/;
      function C(e, a, n, t) {
        var i,
        ...
        a.on("directory", function () {
          ...
          n.headers &&
            a.on("headers", function (e) {
              for (
                var a = n.headers, t = Object.keys(a), i = 0;
                i < t.length;
                i++
              ) {
                var o = t[i];
      ...
      function T(e, a, n, t) {
        var i = a || n ? JSON.stringify(e, a, n) : JSON.stringify(e);
        return (
          t &&
            "string" == typeof i &&
      ...
      (S.status = function (e) {
        ...
        (S.send = function (e) {
          ...
          switch (
            ...
            case "object":
              if (null === i) i = "";
                ...
                if (!t.isBuffer(i)) return this.json(i);
          ...
          "string" == typeof i &&
            ...
            "string" == typeof (n = this.get("Content-Type")) &&
              this.set("Content-Type", b(n, "utf-8")));
          var c,
            p,
            l = s.get("etag fn"),
          ...
          return (
            void 0 !== i &&
              (t.isBuffer(i)
                ...
                : !u && i.length < 1e3
                ? (c = t.byteLength(i, a))
                : ((i = t.from(i, a)), (a = void 0), (c = i.length)),
              this.set("Content-Length", c)),
            u && void 0 !== c && (p = l(i, a)) && this.set("ETag", p),
            ...
            205 === this.statusCode &&
              ...
              this.removeHeader("Transfer-Encoding"),
              (i = "")),
            "HEAD" === o.method ? this.end() : this.end(i, a),
            this
          );
        }),
        (S.json = function (e) {
        ...
        (S.sendStatus = function (e) {
          var a = f.message[e] || String(e);
          return (this.statusCode = e), this.type("txt"), this.send(a);
        }),
        (S.sendFile = function (e, a, n) {
          var t = n,
            i = this.req,
            o = i.next,
            r = a || {};
          ...
          if (("function" == typeof a && ((t = a), (r = {})), !r.root && !l(e)))
            throw new TypeError(
              "path must be absolute or specify root to res.sendFile"
            );
          var s = encodeURI(e);
          C(this, y(i, s, r), r, function (e) {
            return t
              ? t(e)
              : e && "EISDIR" === e.code
              ? o()
        ...
        (S.sendfile = function (e, a, n) {
          var t = n,
            ...
            o = i.next,
            r = a || {};
          "function" == typeof a && ((t = a), (r = {})),
            C(this, y(i, e, r), r, function (e) {
              return t
                ? t(e)
                : e && "EISDIR" === e.code
                ? o()
        ...
        (S.sendfile = r.function(
          S.sendfile,
          "res.sendfile: Use res.sendFile instead"
        )),
        (S.download = function (e, a, n, t) {
          var o = t,
            r = a,
            s = n || null;
          "function" == typeof a
            ...
            "object" != typeof a ||
              ...
              ((r = null), (s = a));
          var c = { "Content-Disposition": i(r || e) };
          if (s && s.headers)
        ...
        (S.contentType = S.type =
          function (e) {
            var a = -1 === e.indexOf("/") ? k.lookup(e) : e;
        ...
        (S.format = function (e) {
          var a = this.req,
            ...
            i = t.length > 0 && a.accepts(t);
          return (
            this.vary("Accept"),
            i
              ? (this.set("Content-Type", h(i).value), e[i](a, this, n))
              : e.default
              ? e.default(a, this, n)
              : n(
                  o(406, {
                    types: x(t).map(function (e) {
                      return e.value;
                    }),
                  })
                ),
        ...
        (S.attachment = function (e) {
          return (
            e && this.type(w(e)), this.set("Content-Disposition", i(e)), this
          );
        }),
        (S.append = function (e, a) {
          var n = this.get(e),
            t = a;
          return (
            n &&
          ...
          function (e, a) {
            if (2 === arguments.length) {
              ...
              if ("content-type" === e.toLowerCase()) {
                ...
                if (!j.test(n)) {
                  var t = k.charsets.lookup(n.split(";")[0]);
                  t && (n += "; charset=" + t.toLowerCase());
                }
              }
              this.setHeader(e, n);
        ...
        (S.clearCookie = function (e, a) {
          var n = m({ expires: new Date(1), path: "/" }, a);
          return this.cookie(e, "", n);
        }),
        (S.cookie = function (e, a, n) {
          var t = m({}, n),
            i = this.req.secret,
            o = t.signed;
          if (o && !i)
          ...
          var r = "object" == typeof a ? "j:" + JSON.stringify(a) : String(a);
          if ((o && (r = "s:" + v(r, i)), null != t.maxAge)) {
            var s = t.maxAge - 0;
            isNaN(s) ||
              ((t.expires = new Date(Date.now() + s)),
              (t.maxAge = Math.floor(s / 1e3)));
          }
          return (
            null == t.path && (t.path = "/"),
            this.append("Set-Cookie", g.serialize(e, String(r), t)),
            this
          );
        }),
        ...
        (S.redirect = function (e) {
          ...
          2 === arguments.length &&
            ...
            this.format({
              text: function () {
                a = f.message[i] + ". Redirecting to " + n;
              },
              html: function () {
                var e = c(n);
                a =
            ...
            (this.statusCode = i),
            this.set("Content-Length", t.byteLength(a)),
        ...
        (S.render = function (e, a, n) {
          var t = this.req.app,
            i = n,
            o = a || {},
            r = this.req,
            s = this;
          "function" == typeof a && ((i = a), (o = {})),
            (o._locals = s.locals),
            (i =
              i ||
              function (e, a) {
    ...
    function (e, a, n) {
      var t = n(58);
      function i(e) {
        return t.createHash("sha1").update(e).digest("hex");
      }
      (a.sign = function (e, a) {
        if ("string" != typeof e)
        ...
        (a.unsign = function (e, n) {
          if ("string" != typeof e)
            throw new TypeError("Signed cookie string must be provided.");
          if ("string" != typeof n)
            throw new TypeError("Secret string must be provided.");
          var t = e.slice(0, e.lastIndexOf("."));
          return i(a.sign(t, n)) == i(e) && t;
        });
    },
    function (e, a, n) {
      "use strict";
       ...
       */ (a.parse = function (e, a) {
        ...
        for (; i < e.length; ) {
          ...
          var p = e.slice(i, r).trim();
          if (void 0 === n[p]) {
            var l = e.slice(r + 1, c).trim();
            34 === l.charCodeAt(0) && (l = l.slice(1, -1)), (n[p] = s(l, t));
          }
          i = c + 1;
        }
        return n;
      }),
        (a.serialize = function (e, a, n) {
          var o = n || {},
            s = o.encode || r;
          if ("function" != typeof s)
              ...
              if (this.hasTrailingSlash()) this.error(404);
                ...
                var n,
                  ...
                  p =
                    ((n = "Redirecting"),
                    (r =
                      'Redirecting to <a href="' + i(s) + '">' + i(s) + "</a>"),
                    '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="utf-8">\n<title>' +
                      n +
                      "</title>\n</head>\n<body>\n<pre>" +
                      r +
    ...
    function (e, a, n) {
      ...
      function r(e, a) {
        ...
        e[i].push(Buffer.from(a));
      }
      e.exports = class e extends t.ServerResponse {
        static from(a) {
          const n = new e(a);
          return (
            (n.statusCode = a.statusCode),
            (n[o] = a.headers),
            (n[i] = [Buffer.from(a.body)]),
            n.end(),
            n
          );
        }
        static body(e) {
          return Buffer.concat(e[i]);
        }
        static headers(e) {
          const a =
            "function" == typeof e.getHeaders ? e.getHeaders() : e._headers;
        ...
        writeHead(e, a, n) {
          const t = "string" == typeof a ? n : a;
          for (const e in t)
            if ((this.setHeader(e, t[e]), !this._wroteHeader)) break;
          super.writeHead(e, a, n);
        }
            ...
            this.assignSocket({
              ...
              write: (e, a, n) => {
                if (
                  ...
                  const a = (function (e) {
                      if (Buffer.isBuffer(e)) return e.toString("utf8");
    ...
    function (e, a, n) {
      "use strict";
      const t = n(8);
      e.exports = class extends t.IncomingMessage {
        constructor({
          method: e,
          url: a,
          headers: n,
          ...
          super({
            ...
            void 0 === n["content-length"] &&
              (n["content-length"] = Buffer.byteLength(t)),
            Object.assign(this, {
              ip: i,
              complete: !0,
              httpVersion: "1.1",
    ...
    function (e, a, n) {
      ...
      s.get("/", function (e, a) {
        ...
        s.get("/test", function (e, a) {
          a.json({ hello: "test!" });
        }),
        r.use(o()),
        r.use(t.json()),
        r.use(t.urlencoded({ extended: !1 })),
        r.use(s),
        r.use("/.netlify/functions/api", s),
        (e.exports = r),
        (e.exports.handler = i(r));
    },
    function (e, a, n) {
      "use strict";
      const t = n(174),
      ...
      e.exports = function (e, a) {
        const n = Object.assign({}, r, a),
          s = i(e);
        return o(n)(async (e, ...a) => {
          await t(e, n.request, ...a);
          const i = await s(e);
          return await t(i, n.response, ...a), i;
        });
      };
    },
    function (e, a, n) {
      "use strict";
      e.exports = async function (e, a, ...n) {
        return (
          await new Promise((a, n) => {
            if (e.finished || e.complete) return void a();
            let t = !1;
            function i(o) {
              t ||
                ((t = !0),
            ...
            e.once("error", i), e.once("end", i), e.once("finish", i);
          }),
          "function" == typeof a
            ? await a(e, ...n)
            : "object" == typeof a && null !== a && Object.assign(e, a),
          e
        );
      };
    },
    function (e, a, n) {
      ...
      e.exports = function (e) {
        if ("function" == typeof e.callback) return i(e.callback());
        ...
        if ("function" == typeof e._onRequest)
          return i((a, n) => {
            e._onRequest(a, n);
          });
        if ("function" == typeof e) return i(e);
        if (e.router && "function" == typeof e.router.route)
          return i((a, n) => {
            const { url: t, method: i, headers: o, body: r } = a;
            e.router.route({ url: t, method: i, headers: o, body: r }, n);
          });
        if (e._core && "function" == typeof e._core._dispatch)
          return i(e._core._dispatch({ app: e }));
        if ("function" == typeof e.inject)
          return async (a) => {
            const { method: n, url: i, headers: o, body: r } = a,
              s = await e.inject({ method: n, url: i, headers: o, payload: r });
            return t.from(s);
          };
        if ("function" == typeof e.main) return i(e.main);
        throw new Error("Unsupported framework");
      };
    },
    function (e, a, n) {
      const t = { aws: n(177), azure: n(183) };
      e.exports = function (e) {
        const { provider: a = "aws" } = e;
        if (a in t) return t[a](e);
    ...
    function (e, a, n) {
      ...
      function t(e = "/", a) {
        if (a) {
          const n = e.indexOf(a);
          if (n > -1) return e.substr(n + a.length) || "/";
        }
        return e;
      }
      function i(e) {
      ...
      function r(e) {
        ...
        if (Array.isArray(e)) {
          const a = [];
          for (let n in e) a.push(r(e[n]));
          return a;
        }
        if (e instanceof Object) {
          const a = {};
          for (let n of Object.keys(e)) a[o(n)] = r(e[n]);
          return a;
        }
        return e;
      }
      e.exports = function (e, a) {
        const n = e || {};
        return (
          (n.requestContext = n.requestContext || {}),
          (n.body = n.body || ""),
          (n.headers = n.headers || {}),
          "elb" in n.requestContext &&
            (n.multiValueQueryStringParameters &&
              (n.multiValueQueryStringParameters = r(
                n.multiValueQueryStringParameters
              )),
            n.queryStringParameters &&
              (n.queryStringParameters = r(n.queryStringParameters))),
          "2.0" === n.version
            ? ((n.requestContext.authorizer =
                n.requestContext.authorizer || {}),
              (n.requestContext.http.method =
                n.requestContext.http.method || "GET"),
              (n.rawPath = t(n.requestPath || n.rawPath, a.basePath)))
            : ((n.requestContext.identity = n.requestContext.identity || {}),
              (n.httpMethod = n.httpMethod || "GET"),
              (n.path = t(n.requestPath || n.path, a.basePath))),
          n
        );
      };
    },
    function (e, a, n) {
      ...
      e.exports = (e, a, n) => {
        const o = (function (e) {
          ...
          s = (function (e) {
            const a =
              "2.0" === e.version && Array.isArray(e.cookies)
                ? { cookie: e.cookies.join("; ") }
                : {};
            return e.multiValueHeaders
              ? Object.keys(e.multiValueHeaders).reduce(
                  (a, n) => (
                    (a[n.toLowerCase()] = e.multiValueHeaders[n].join(", ")), a
                  ),
                  a
                )
              : Object.keys(e.headers).reduce(
                  (a, n) => ((a[n.toLowerCase()] = e.headers[n]), a),
                  a
                );
          })(e),
          c = (function (e) {
            const a = typeof e.body;
            if (Buffer.isBuffer(e.body)) return e.body;
            if ("string" === a)
              return Buffer.from(e.body, e.isBase64Encoded ? "base64" : "utf8");
            if ("object" === a) return Buffer.from(JSON.stringify(e.body));
          ...
          p = (function (e) {
            ...
            return (
              e.queryStringParameters &&
                Object.keys(e.queryStringParameters).forEach((n) => {
                  Array.isArray(a[n])
                    ? a[n].includes(e.queryStringParameters[n]) ||
                      a[n].push(e.queryStringParameters[n])
                    : (a[n] = [e.queryStringParameters[n]]);
                }),
              t.format({ pathname: e.path, query: a })
            );
          })(e);
        if ("string" == typeof n.requestId && n.requestId.length > 0) {
          const a = n.requestId.toLowerCase(),
            t = s[a] || e.requestContext.requestId;
          t && (s[a] = t);
        }
        const l = new i({
          method: o,
    ...
    function (e, a, n) {
      ...
      e.exports = (e, a, n) => {
        const { statusCode: r } = a,
          { headers: s, multiValueHeaders: c } = o(i.headers(a));
        let p = [];
        c["set-cookie"] && (p = c["set-cookie"]);
        const l = t(s, n),
          u = l ? "base64" : "utf8";
        let d = i.body(a).toString(u);
        if ("chunked" === s["transfer-encoding"] || a.chunkedEncoding) {
          const e = i.body(a).toString().split("\r\n"),
            n = [];
          for (let a = 0; a < e.length; a += 2) {
            const t = parseInt(e[a], 16),
              i = e[a + 1];
            i && n.push(i.substring(0, t));
          }
          d = n.join("");
        }
        let f = { statusCode: r, headers: s, isBase64Encoded: l, body: d };
        return (
          "2.0" === e.version && p.length && (f.cookies = p),
          (e.version && "1.0" !== e.version) ||
            !Object.keys(c).length ||
            (f.multiValueHeaders = c),
          f
        );
      };
    },
    function (e, a, n) {
      "use strict";
      const t = ["gzip", "deflate", "br"],
        i = (process.env.BINARY_CONTENT_TYPES || "").split(",");
      e.exports = function (e, a) {
        return (
          !1 !== a.binary &&
          (!0 === a.binary ||
            ("function" == typeof a.binary
              ? a.binary(e)
              : (function (e) {
                  ...
                  if ("string" == typeof a)
                    return a
                      .split(",")
                      .some((e) => t.some((a) => -1 !== e.indexOf(a)));
                })(e) ||
                (function (e, a) {
                  const n = []
                      .concat(a.binary ? a.binary : i)
                      .map((e) => new RegExp(`^${e.replace(/\*/g, ".*")}$`)),
                    t = (e["content-type"] || "").split(";")[0];
      ...
      e.exports = function (e) {
        return Object.keys(e).reduce(
          (a, n) => {
            ...
            return (
              Array.isArray(t)
                ? ((a.multiValueHeaders[n] = t),
                  "set-cookie" !== n.toLowerCase() &&
                    (a.headers[n] = t.join(", ")))
                : (a.headers[n] = null == t ? "" : t.toString()),
              a
            );
          },
    ...
    function (e, a, n) {
      const t = n(184),
        i = n(185),
        o = n(186);
      e.exports = (e) => (a) => async (n, r) => {
        const s = t(r, e),
          c = i(s, e),
          p = await a(c, n, s);
        return n.log(p), o(p, e);
      };
    },
    function (e, a, n) {
      "use strict";
      e.exports = function (e, a) {
        const n = e || {};
        if (
          ((n.requestContext = (function (e) {
            const a = { identity: {} },
              n = e.headers["x-forwarded-for"],
              t = e.headers["client-ip"],
              i = n || t || "";
            return i && (a.identity.sourceIp = i.split(":")[0]), a;
          })(e)),
          (n.method = n.method || "GET"),
          (n.url = (function ({ requestPath: e, url: a }) {
            return e || ("string" == typeof a ? a : "/");
          })(n)),
          (n.body = n.body || ""),
          (n.headers = n.headers || {}),
          a.basePath)
        ) {
          const e = n.url.indexOf(a.basePath);
          e > -1 && (n.url = n.url.substr(e + a.basePath.length));
        }
        return n;
      };
    },
      ...
      e.exports = (e) => {
        const a = e.method,
          ...
          r = (function (e) {
            ...
            if (Buffer.isBuffer(e.rawBody)) return e.rawBody;
            if ("string" === a) return Buffer.from(e.rawBody, "utf8");
            if ("object" === a) return Buffer.from(JSON.stringify(e.rawBody));
            throw new Error(
              "Unexpected request.body type: " + typeof e.rawBody
            );
          })(e),
          s = new i({
            method: a,
            headers: o,
            body: r,
            url: t.format({ pathname: e.url, query: n }),
          });
    ...
    function (e, a, n) {
      const t = n(187),
        ...
        o = n(188);
      e.exports = (e, a) => {
        const { statusCode: n } = e,
          r = o(i.headers(e));
        if ("chunked" === r["transfer-encoding"] || e.chunkedEncoding)
    ...
    function (e, a, n) {
      ...
      (e.exports = function (e) {
        ...
        return function (e, o, f) {
          var v,
            ...
            w = o.write;
          function k(e) {
            s("no compression: %s", e), d(o, y, b), (b = null);
          }
          (o.flush = function () {
            h && h.flush();
          }),
            (o.write = function (e, a) {
              return (
                !x &&
                (this._header || this._implicitHeader(),
                h ? h.write(m(e, a)) : w.call(this, e, a))
              );
            }),
            (o.end = function (e, a) {
              return (
                ...
                (this._header ||
                  (this.getHeader("Content-Length") ||
                    (v = (function (e, a) {
                      if (!e) return 0;
                      return i.isBuffer(e) ? e.length : i.byteLength(e, a);
                    })(e, a)),
                  this._implicitHeader()),
                h
                  ? ((x = !0), e ? h.end(m(e, a)) : h.end())
                  : g.call(this, e, a))
              );
            }),
            (o.on = function (e, a) {
            ...
            c(o, function () {
              if (n(e, o))
                if (
                  (function (e, a) {
                    var n = a.getHeader("Cache-Control");
                    return !n || !u.test(n);
                  })(0, o)
                )
                  if (
                    (p(o, "Accept-Encoding"),
                    Number(o.getHeader("Content-Length")) < r || v < r)
                  )
                    k("size below threshold");
                  else if (
                    "identity" ===
                    (o.getHeader("Content-Encoding") || "identity")
                  )
                    if ("HEAD" !== e.method) {
                      var i = t(e),
                      ...
                      "deflate" === c &&
                        ...
                        c && "identity" !== c
                          ? (s("%s compression", c),
                            ...
                            o.setHeader("Content-Encoding", c),
                            o.removeHeader("Content-Length"),
                            h.on("data", function (e) {
                              !1 === w.call(o, e) && h.pause();
                            }),
                            h.on("end", function () {
                              g.call(o);
                            }),
                            y.call(o, "drain", function () {
                              h.resume();
                            }))
                          : k("not acceptable");
                    } else k("HEAD request");
                  else k("already encoded");
                else k("no transform");
              else k("filtered");
            }),
            f();
      ...
      function d(e, a, n) {
        for (var t = 0; t < n.length; t++) a.apply(e, n[t]);
      }
      function f(e, a) {
        var n = a.getHeader("Content-Type");
        return !(void 0 === n || !r(n)) || (s("%s not compressible", n), !1);
      }
      function m(e, a) {
        return i.isBuffer(e) ? e : i.from(e, a);
      }
    },
    function (e, a, n) {
      var t = n(7),
    ...
    function (e, a, n) {
      ...
      var t = /\B(?=(\d{3})+(?!\d))/g,
        i = /(?:\.0*|(\.[^0]+)0+)$/,
        o = { b: 1, kb: 1024, mb: 1 << 20, gb: 1 << 30, tb: 1024 * (1 << 30) },
        r = /^((-|\+)?(\d+(?:\.\d+)?)) *(kb|mb|gb|tb)$/i;
      function s(e, a) {
        if (!Number.isFinite(e)) return null;
        var n = Math.abs(e),
        ...
        var u = (e / o[l.toLowerCase()]).toFixed(c);
        return (
          p || (u = u.replace(i, "$1")), r && (u = u.replace(t, r)), u + s + l
        );
      }
      function c(e) {
        if ("number" == typeof e && !isNaN(e)) return e;
    ...
    function (e, a, n) {
      ...
      e.exports = function (e) {
        ...
        var a = o.exec(e),
          n = a && a[1].toLowerCase(),
          r = t[n];
        if (r && void 0 !== r.compressible) return r.compressible;
        return i.test(n) || void 0;
      };
    },
    function (e, a, n) {
      "undefined" != typeof process && "renderer" === process.type
    ...
    function (e, a, n) {
      ...
      ((a = e.exports = n(157)).log = function () {
        return (
          "object" == typeof console &&
          console.log &&
          Function.prototype.apply.call(console.log, console, arguments)
    ...
    function (e, a, n) {
      var t = n(13),
        i = n(2);
      ((a = e.exports = n(157)).init = function (e) {
        e.inspectOpts = {};
        for (var n = Object.keys(a.inspectOpts), t = 0; t < n.length; t++)
          e.inspectOpts[n[t]] = a.inspectOpts[n[t]];
      }),
    ...
    function (e, a, n) {
       ...
       * MIT Licensed
       */ function t(e, a) {
        for (var n = 0; n < a.length; n++) e.setHeader(a[n][0], a[n][1]);
      }
      function i(e, a) {
        for (var n = Object.keys(a), t = 0; t < n.length; t++) {
          var i = n[t];
      ...
      function o(e) {
        var a = arguments.length,
          n = a > 1 && "string" == typeof arguments[1] ? 2 : 1,
          o = a >= n + 1 ? arguments[n] : void 0;
        (this.statusCode = e), Array.isArray(o) ? t(this, o) : o && i(this, o);
        for (var r = new Array(Math.min(a, n)), s = 0; s < r.length; s++)
          r[s] = arguments[s];
        return r;
      }
      e.exports = function (e, a) {
